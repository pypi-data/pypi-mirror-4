...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.rating_bonus'
        db.add_column('ratings_badge', 'rating_bonus', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.rating_bonus'
        db.delete_column('ratings_badge', 'rating_bonus')
