...
# if it fails to import InotifyObsever (only available on linux), it will then try to import fsevents
# which is available on osx, but doesn't work well. instead, we just want the polling observer, which is slower,
# but it does seem to do the job right
