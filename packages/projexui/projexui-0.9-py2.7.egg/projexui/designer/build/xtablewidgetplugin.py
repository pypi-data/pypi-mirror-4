...
from projexui.widgets.xtablewidget import XTableWidget as Base

class XTableWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTableWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtablewidget'
    
    def domXml( self ):
        default = '<widget class="XTableWidget" name="XTableWidget"/>'
