...
// lino.js --- generated Sun Mar 17 10:44:51 2013 by Lino version 1.6.2.
...
Lino.users.MySettings.InsertFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var language44 = new Lino.ChoicesFieldElement({ "fieldLabel": "Language", "allowBlank": false, "selectOnFocus": true, "hiddenName": "languageHidden", "anchor": "-20", "store": [ [ "en", "English" ] ], "name": "language" });
...
Lino.users.MySettings.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var language63 = new Lino.ChoicesFieldElement({ "selectOnFocus": true, "allowBlank": false, "store": [ [ "en", "English" ] ] });
