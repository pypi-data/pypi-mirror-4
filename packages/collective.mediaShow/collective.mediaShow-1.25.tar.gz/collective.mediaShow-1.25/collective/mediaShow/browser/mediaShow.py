...
class MediaShowListingView(BrowserView):
    ...
    def getMediaURL(self, item):
        ...
        #TODO: Added this to avoid the problem with Folders being shown as images and repeated images in the folder and the image itself (what a shity explaination...)
        return ""
