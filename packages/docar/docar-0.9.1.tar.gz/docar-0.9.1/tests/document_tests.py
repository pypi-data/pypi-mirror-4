...
from docar.backends import DummyBackend, Backend
...
class describe_the_documents_mechanics(unittest.TestCase):
    ...
    def it_can_specify_a_backend_in_different_ways(self):
        """Supply the backend either with its name, or as a class."""
        ...
        eq_(True, isinstance(MyDocument()._meta.backend, MyBackend))
