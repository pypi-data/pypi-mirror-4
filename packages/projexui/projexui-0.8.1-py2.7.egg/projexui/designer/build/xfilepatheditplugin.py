...
from projexui.widgets.xfilepathedit import XFilepathEdit as WidgetClass

class XFilepathEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XFilepathEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xfilepathedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XFilepathEdit" name="XFilepathEdit"/>'
