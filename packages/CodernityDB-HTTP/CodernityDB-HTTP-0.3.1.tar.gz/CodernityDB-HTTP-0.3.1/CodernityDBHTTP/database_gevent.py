...
class HTTPGeventDatabase(GeventDatabase):
    ...
    def count(self, method, *args, **kwargs):
        func = getattr(super(HTTPGeventDatabase, self), method)
        return super(HTTPGeventDatabase, self).count(func, *args, **kwargs)
    ...
    def update(self, data):
        res = super(HTTPGeventDatabase, self).update(data)
        if res:
            return res
        else:
            raise HTTPDatabaseException("Invalid return data from Database")
    ...
    def delete(self, data):
        res = super(HTTPGeventDatabase, self).delete(data)
        return res

    def get_many(self, *args, **kwargs):
        return super(HTTPGeventDatabase, self).get_many(*args, **kwargs)

    def all(self, *args, **kwargs):
        return super(HTTPGeventDatabase, self).all(*args, **kwargs)
