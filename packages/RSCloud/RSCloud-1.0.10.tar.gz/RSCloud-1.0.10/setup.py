...
setup(
    ...
    long_description = 'version updates to CloudDB.py and CloudMonitor.py to accommodate changes to Rackspace Cloud APIs since December 2012. Documentation at http://pythonhosted.org/RSCloud/',
