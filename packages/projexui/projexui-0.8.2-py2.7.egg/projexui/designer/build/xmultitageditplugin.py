...
from projexui.widgets.xmultitagedit import XMultiTagEdit as WidgetClass

class XMultiTagEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XMultiTagEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xmultitagedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XMultiTagEdit" name="XMultiTagEdit"/>'
