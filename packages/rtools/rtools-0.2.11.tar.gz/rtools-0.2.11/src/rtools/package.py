...
#
##############################################################################
# $Id: package.py 11 2013-02-04 15:37:58Z cokelaer $
...
class RPackage(object):
    ...
    def _load(self):
        ...
        try:
            ...
            self.logging.error("Package %s not installedi. Install it from R or with rtools.package.RPackageManager" % self.name)
        Rwarning(True)
