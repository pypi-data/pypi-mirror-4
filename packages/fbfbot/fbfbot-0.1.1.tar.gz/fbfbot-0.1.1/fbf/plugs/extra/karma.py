...
from fbf.lib.persist import PlugPersist, PlugPersistCollection
...
examples.add('karma', 'show karma', 'karma fbf')
...
examples.add("karma-whyup", "show why a karma item is upped", "karma-whyup fbf")
...
examples.add("karma-whoup", "show who upped an item", "karma-whoup fbf")
...
examples.add("karma-whydown", "show why a karma item is downed", "karma-whydown fbf")
...
examples.add("karma-whodown", "show who downed an item", "karma-whodown fbf")
