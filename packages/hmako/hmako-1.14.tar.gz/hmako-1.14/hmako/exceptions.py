    ...
    def _init(self, trcback):
        ...
        for filename, lineno, function, line in rawrecords:
            ...
            try:
                ...
                try:
                    info = hmako.template._get_module_info(filename)
...
def text_error_template(lookup=None):
    ...
    """
    import hmako.template
    return hmako.template.Template(r"""
<%page args="error=None, traceback=None"/>
<%!
    from hmako.exceptions import RichTraceback
%>\
<%
...
def _install_pygments():
    ...
    from hmako.ext.pygmentplugin import syntax_highlight,\
            pygments_html_formatter

def _install_fallback():
    global syntax_highlight, pygments_html_formatter
    from hmako.filters import html_escape
...
def html_error_template():
    ...
    return hmako.template.Template(r"""
<%!
    from hmako.exceptions import RichTraceback, syntax_highlight,\
            pygments_html_formatter
%>
...
% for index in range(max(0, line-4),min(len(lines), line+5)):
    ...
    %>
        ${lines[index] | syntax_highlight(language='hmako')}
    <%
       if pygments_html_formatter:
