...
class IZopeDataSourceInfo(IBasicDataSourceInfo):
    ...
    zopeURI = schema.Text(title=_t(u'URI of Zope Server'))
    timeout = schema.Int(title=_t(u'Connection Timeout (seconds)'))


class IZopeThreadsDataSourceInfo(IZopeDataSourceInfo): pass
class IZopeDBActivityDataSourceInfo(IZopeDataSourceInfo): pass
class IZopeMemoryDataSourceInfo(IZopeDataSourceInfo): pass
class IZopeCacheDataSourceInfo(IZopeDataSourceInfo): pass
