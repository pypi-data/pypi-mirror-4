...
class TestQuidditas(TestCase):
    ...
    def test_add_entity_by_type(self):
        """ Test assembling an entity by a type name. """
    ...
    def test_add_remove_processor(self):
        """ Test adding and removing a processor instance and if this
        processor receives proper calls from quidditas. """
    ...
    def test_remove_processor(self):
        """ Test if processors can be removed from the processor manager
        via quidditas. """
        proc = TestingProcessorA()
    ...
    def test_remove_entity_gid(self):
        """ Test if a single entity can be removed by its gid and that
        the managers are notified of that change on the next update (and
        not before). """
        e = quidditas.Entity()
    ...
    def test_add_component(self):
        """ Test if components can be added to an entity after its
        creation. """
    ...
    def test_remove_component(self):
        """ Test removing components via quidditas. """
        entity = quidditas.Entity()
        comp = TestingComponentA()
...
class TestEntity(TestCase):
    ...
    def test_get_component_without_quidditas(self):
        """ Test if components can be retrieved when an entity is not yet
        associated with a quidditas instance. """
        comp = TestingComponentA()
    ...
    def test_get_component_with_quidditas(self):
        """ Test if components can be retrieved when an entity
        is associated with a quidditas instance. """
        comp = TestingComponentA()
        self.q = quidditas.Quidditas()
        self.q.add_entity(self.e)
        self.e.add_component(comp)
