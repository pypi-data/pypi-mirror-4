...
model.sens_state_0.setValue(model.c_init_var, 1)
model.sens_state_0.setValue(model.t_init_var, 2)
model.sens_state_1.setValue(model.c[4,0], 1)
model.sens_state_1.setValue(model.t[4,0], 2)
model.sens_state_value_1.setValue(model.c[4,0], 0.135)
model.sens_state_value_1.setValue(model.t[4,0], 0.745)
model.sens_init_constr.setValue(model.c_init_def, 1)
model.sens_init_constr.setValue(model.t_init_def, 1)
###
...
for k,(i,j) in enumerate(collocation_idx(nfe, ncp)):
    ...
    cperturbed[k] = model.sens_sol_state_1.getValue(model.c[i,j])
    tperturbed[k] = model.sens_sol_state_1.getValue(model.t[i,j])
