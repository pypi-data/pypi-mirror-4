...
# Generated 2013-04-17 03:14:18.451953 by PyXB version 1.2.2
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:cd06ea3e-a736-11e2-8e6d-c8600024e903')
...
class DCEValueType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/saml20/schemas/dce.xsd', 18, 4)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __Realm._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/saml20/schemas/dce.xsd', 26, 4)
    __Realm._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/saml20/schemas/dce.xsd', 21, 16)
    ...
    __FriendlyName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/saml20/schemas/dce.xsd', 27, 4)
    __FriendlyName._UseLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/saml20/schemas/dce.xsd', 22, 16)
