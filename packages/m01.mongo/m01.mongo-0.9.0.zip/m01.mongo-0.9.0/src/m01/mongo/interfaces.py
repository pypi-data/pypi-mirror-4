...
class IMongoObjectAware(zope.interface.Interface):
    ...
    concept whould be to write the MongoObject _id into the MongoAwareObject
    which whould force a write access to both the MongoAwareObject and
    MongoObject.
