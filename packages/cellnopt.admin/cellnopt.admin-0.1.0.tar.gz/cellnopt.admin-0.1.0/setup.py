...
metainfo = {
    ...
    'version': version,
    'license' : 'GPL',
    'download_url' : ['http://pypi.python.org/pypi/cnolab.admin'],
    'url' : ['http://www.ebi.ac.uk/~cokelaer/cnolab/admin'],
    'description':'tools to manage cellnopt (python and R versions)' ,
