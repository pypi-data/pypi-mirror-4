...
class CloudServersNG(Cloud):
    ...
    def getLimits(self):
        ...
        return self.apiRequest( endpoint, "GET", returnResults=True)
    ...
    def getExtensions(self, extension=None):
        ...
        log.info("getExtensions GET to %s" % self.endpoint)
        return self.apiRequest( endpoint, "GET", returnResults=True)
    ...
    def setServerAttr(self, sId, attrDict):
        ...
        log.info("setServerAttr PUT to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "PUT", self.postData, returnResults=True)
    ...
    def _setAction(self, sId, actionList, returnResults=False):
        ...
        log.info("_setAction POST to %s with data - %s" % (self.endpoint, str(self.postData)))
    ...
    def createAttVolume(self, sId, volumeList):
        ...
        log.info("createAttVolume POST to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "POST", self.postData, returnResults=True)
    ...
    def getAttVolumes(self, sId, vId=None):
        ...
        log.info("getAttVolumes GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def deleteAttVolume(self, sId, vId):
        ...
        log.info("deleteAttVolume DELETE to %s" % self.endpoint)
        return self.apiRequest(self.endpoint,"DELETE")
    ...
    def getMeta(self, mType, mId, key=None):
        ...
        log.info("getMeta GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def setMeta(self, mType, mId, metaDict, key=None):
        ...
        log.info("setMeta PUT to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "PUT", self.postData, returnResults=True)
    ...
    def updateMeta(self, mType, mId, metaList):
        ...
        log.info("updateMeta POST to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "POST", self.postData, returnResults=True)
    ...
    def deleteMeta(self, mType, mId, key):
        ...
        log.info("deleteMeta DELETE to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "DELETE")
