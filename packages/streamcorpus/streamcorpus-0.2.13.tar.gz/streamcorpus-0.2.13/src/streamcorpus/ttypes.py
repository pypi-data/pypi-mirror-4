...
class Token(object):
  ...
  Should probably convert this to an enum, analogous to EntityType
   ...
   - mention_id: Identifier for a multi-token mention starts at zero for each
...
class ContentItem(object):
  ...
  def __init__(self, raw=None, encoding=None, media_type=None, clean_html=None, clean_visible=None, logs=thrift_spec[6][4], taggings=thrift_spec[7][4], labels=thrift_spec[8][4], sentences=thrift_spec[9][4], sentence_blobs=thrift_spec[10][4], language=None,):
    self.raw = raw
  ...
  def write(self, oprot):
    ...
    if self.taggings is not None:
      ...
      for kiter104,viter105 in self.taggings.items():
    ...
    if self.labels is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.labels))
      for kiter106,viter107 in self.labels.items():
        oprot.writeString(kiter106)
        oprot.writeListBegin(TType.STRUCT, len(viter107))
    ...
    if self.sentences is not None:
      ...
      for kiter109,viter110 in self.sentences.items():
    ...
    if self.sentence_blobs is not None:
      ...
      for kiter112,viter113 in self.sentence_blobs.items():
...
class StreamItem(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i125 in xrange(_size121):
            ...
            self.source_metadata[_key126] = _val127
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        ...
        if ftype == TType.MAP:
          ...
          for _i132 in xrange(_size128):
            ...
            _val134 = ContentItem()
            _val134.read(iprot)
            self.other_content[_key133] = _val134
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.MAP:
          ...
          for _i139 in xrange(_size135):
            ...
            for _i146 in xrange(_size142):
              _elem147 = Rating()
              _elem147.read(iprot)
              _val141.append(_elem147)
            iprot.readListEnd()
            self.ratings[_key140] = _val141
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.source_metadata is not None:
      ...
      for kiter148,viter149 in self.source_metadata.items():
    ...
    if self.other_content is not None:
      ...
      for kiter150,viter151 in self.other_content.items():
    ...
    if self.ratings is not None:
      ...
      for kiter152,viter153 in self.ratings.items():
        oprot.writeString(kiter152)
        oprot.writeListBegin(TType.STRUCT, len(viter153))
