...
//                    RGraph.Text(this.context, font, size, x, y, labels[i], 'center', 'center', true, null, 'white');
                    if (angle > Math.PI/4 && angle < 3*Math.PI/2) { // angle > 45 deg and angle < 270
                        RGraph.Text(this.context, font, size, x, y, labels[i], 'center', 'right', null, null, null); // right
                    } else {
                        RGraph.Text(this.context, font, size, x, y, labels[i], 'center', 'left', null, null, null); // left
                    }
