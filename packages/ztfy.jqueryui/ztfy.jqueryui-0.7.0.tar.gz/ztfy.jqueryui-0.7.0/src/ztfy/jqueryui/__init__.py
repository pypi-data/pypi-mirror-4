...
jquery_19 = Resource(library, 'js/jquery-1.9.1.js', minified='js/jquery-1.9.1.min.js')
jquery = jquery_17
...
jquery_ui_base_17 = Resource(library, 'js/jquery-ui-base-1.7.3.min.js', depends=[jquery_ui_core_17, jquery_ui_css])
jquery_ui_widgets_17 = Resource(library, 'js/jquery-ui-widgets-1.7.3.min.js', depends=[jquery_ui_base_17, jquery_ui_css])
jquery_ui_effects_17 = Resource(library, 'js/jquery-ui-effects-1.7.3.min.js', depends=[jquery_ui_base_17, jquery_ui_css])
...
jquery_ui_base = Resource(library, 'js/jquery-ui-base-1.8.16.min.js', depends=[jquery_ui_core, jquery_ui_css])
jquery_ui_widgets = Resource(library, 'js/jquery-ui-widgets-1.8.16.min.js', depends=[jquery_ui_base, jquery_ui_css])
jquery_ui_effects = Resource(library, 'js/jquery-ui-effects-1.8.16.min.js', depends=[jquery_ui_base, jquery_ui_css])
...
# JQuery Form
jquery_form = Resource(library, 'js/jquery-form-3.27.js', minified='js/jquery-form.min.js', depends=[jquery])

# JQuery Tipsy
jquery_tipsy_css = Resource(library, 'css/jquery-tipsy.css')
jquery_tipsy = Resource(library, 'js/jquery-tipsy.js', depends=[jquery, jquery_tipsy_css])

# JQuery Tools
jquery_tools_11 = Resource(library, 'js/jquery-tools-1.1.2.min.js', depends=[jquery])
jquery_tools_12 = Resource(library, 'js/jquery-tools-1.2.7.min.js', depends=[jquery])
...
jquery_layout = Resource(library, 'js/jquery-layout.js', minified='js/jquery-layout.min.js', depends=[jquery_ui_effects, jquery_layout_css])
...
# JQuery dotdotdot
jquery_dotdotdot = Resource(library, 'js/jquery-dotdotdot.js', depends=[jquery])
