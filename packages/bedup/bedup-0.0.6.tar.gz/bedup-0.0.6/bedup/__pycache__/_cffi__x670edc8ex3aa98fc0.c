...
static PyObject *
_cffi_f_syncfs(PyObject *self, PyObject *arg0)
{
  int x0;
  int result;
...
static PyMethodDef _cffi_methods[] = {
  {"syncfs", _cffi_f_syncfs, METH_O},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_cffi__x670edc8ex3aa98fc0(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x670edc8ex3aa98fc0", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
