...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FBAgendaPlugin.count'
        db.add_column('cmsplugin_fbagendaplugin', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FBAgendaPlugin.count'
        db.delete_column('cmsplugin_fbagendaplugin', 'count')
    ...
    models = {
        ...
        'cmsplugin_fb_agenda.fbagendaplugin': {
    ...
    complete_apps = ['cmsplugin_fb_agenda']