...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('collection_category', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('collection_category', 'image')
    ...
    models = {
        ...
        'collection.product': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 11, 0, 0)'}),
