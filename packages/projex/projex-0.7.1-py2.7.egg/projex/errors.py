...
class ProjexException(Exception):
    """ Base Exception class for all projex exceptions. """
    pass

class ProjexError(ProjexException, StandardError):
    """ Base Error class for all projex errors. """
    pass

class ProjexWarning(ProjexException, Warning):
...
class NotifyError(ProjexError):
    ...
    def __init__( self, error ):
        ProjexError.__init__( 'NotifyError: %s.\n\n' % error )
