...
examples.add('url-search', 'search matching url entries', 'url-search fbfbot')
...
examples.add('url-searchall', 'search matching url entries', 'url-searchall fbfbot')
