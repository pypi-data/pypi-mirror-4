...
from projexui.widgets.xcombobox import XComboBox as Base

class XComboBoxPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XComboBoxPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcombobox'
    
    def domXml( self ):
        default = '<widget class="XComboBox" name="XComboBox"/>'
