...
// lino.js --- generated Thu Feb 21 08:29:14 2013 by Lino version 1.5.10.
...
Lino.status_bar = new Ext.ux.StatusBar({defaultText:'Lino version 1.5.10.'});
...
Lino.about.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var app_disp22 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "app_label", "name": "app", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var name_disp23 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "name", "name": "name", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var docstring_disp24 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "docstring", "name": "docstring", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var rows25 = new Ext.form.NumberField({ "disabled": true, "fieldLabel": "Rows", "anchor": "-20", "name": "rows" });
    var main_1_panel26 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 90, "hideCheckBoxLabels": true, "items": [ { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": app_disp22, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_disp23, "labelAlign": "top" }, { "flex": 31, "autoHeight": true, "layout": "form", "xtype": "panel", "items": docstring_disp24, "labelAlign": "top" }, { "flex": 5, "autoHeight": true, "layout": "form", "xtype": "panel", "items": rows25, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var about_FieldsByModel_grid35 = new Lino.about.FieldsByModel.GridPanel({ "flex": 62, "hide_top_toolbar": true, "containing_panel": this, "viewConfig": { "emptyText": "No data to display." }, "tools": [ Lino.show_in_own_window_button(Lino.about.FieldsByModel.grid) ], "master_panel": this });
    var main_panel36 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel26, about_FieldsByModel_grid35 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel36;
    this.before_row_edit = function(record) {
      about_FieldsByModel_grid35.on_master_changed();
    }
...
Lino.about.About.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var main_panel41 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "fit", "hideCheckBoxLabels": true, "items": [ { "html": "<div class=\"htmlText\"><p><a href=\"http://lino.saffre-rumma.net\" target=\"_blank\">Lino</a> 1.5.10, <a href=\"http://www.djangoproject.com\" target=\"_blank\">Django</a> 1.4.2, <a href=\"http://jinja.pocoo.org/\" target=\"_blank\">Jinja</a> 2.6, <a href=\"http://sphinx-doc.org/\" target=\"_blank\">Sphinx</a> 1.1.3, <a href=\"http://labix.org/python-dateutil\" target=\"_blank\">python-dateutil</a> 1.5, <a href=\"http://cheetahtemplate.org/\" target=\"_blank\">Cheetah</a> 2.4.4, <a href=\"http://pypi.python.org/pypi/odfpy\" target=\"_blank\">OdfPy</a> ODFPY/0.9.4, <a href=\"http://docutils.sourceforge.net/\" target=\"_blank\">docutils</a> 0.10, <a href=\"https://fedorahosted.org/suds/\" target=\"_blank\">suds</a> 0.4.1, <a href=\"http://pyyaml.org/\" target=\"_blank\">PyYaml</a> 3.08, <a href=\"http://appyframework.org/pod.html\" target=\"_blank\">Appy</a> 0.8.0 (2011/12/15 22:41), <a href=\"http://www.python.org/\" target=\"_blank\">Python</a> 2.7.1, <a href=\"http://www.famfamfam.com/lab/icons/silk/\" target=\"_blank\">Silk Icons</a> 1.3, <a href=\"http://www.sencha.com\" target=\"_blank\">ExtJS</a> <a href=\"#\" onclick=\"alert('ExtJS client version is ' + Ext.version);\" title=\"Click to see ExtJS client version\">(version)</a>, <a href=\"http://ext.ensible.com/products/calendar/\" target=\"_blank\">Extensible</a> <a href=\"#\" onclick=\"alert('Extensible Calendar version is ' + Ext.ensible.version);\" title=\"Click to see Extensible Calendar version\">(version)</a></p><ul><li>Server uptime : <b>Thursday, February 21, 2013 at 08:29:05.921000</b></li><li>Source timestamp (lino) : <b>Thursday, February 21, 2013 at 07:47:18</b></li></ul></div>", "xtype": "label" } ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
...
Lino.polls.Polls.InsertFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var question17 = new Ext.form.TextField({ "fieldLabel": "Question text", "name": "question", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var hidden18 = new Ext.form.Checkbox({ "boxLabel": "Hidden", "listeners": { "render": Lino.quicktip_renderer("Hidden","Whether this poll should not be shown in the main window.") }, "hideLabel": true, "checked": false, "name": "hidden", "selectOnFocus": true, "anchor": "-20" });
    var main_panel19 = new Ext.Panel({ "hideCheckBoxLabels": true, "autoHeight": true, "border": false, "layout": "form", "labelWidth": 126, "autoScroll": false, "items": [ { "autoHeight": true, "layout": "form", "xtype": "panel", "items": question17, "anchor": "-20", "labelAlign": "top" }, { "autoHeight": true, "layout": "form", "xtype": "panel", "items": hidden18, "anchor": "-20", "labelAlign": "top" } ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel19;
    this.before_row_edit = function(record) {
    }
...
Lino.ui.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var quick_links_htmlbox37 = new Lino.HtmlBoxPanel({ "flex": 1, "layout": "fit", "name": "quick_links", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "north", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var welcome_htmlbox38 = new Lino.HtmlBoxPanel({ "flex": 5, "layout": "fit", "name": "welcome", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "center", "title": "Welcome", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
    var main_panel39 = new Lino.VBorderPanel({ "autoScroll": false, "border": false, "labelWidth": 72, "hideCheckBoxLabels": true, "items": [ quick_links_htmlbox37, welcome_htmlbox38 ], "frame": true, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel39;
    this.before_row_edit = function(record) {
      quick_links_htmlbox37.refresh();
      welcome_htmlbox38.refresh();
    }
...
Lino.polls.Polls.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var question2 = new Ext.form.TextField({ "fieldLabel": "Question text", "name": "question", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var main_1_panel3 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 126, "hideCheckBoxLabels": true, "items": [ { "flex": 19, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id1, "labelAlign": "top" }, { "flex": 80, "autoHeight": true, "layout": "form", "xtype": "panel", "items": question2, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var hidden6 = new Ext.form.Checkbox({ "boxLabel": "Hidden", "listeners": { "render": Lino.quicktip_renderer("Hidden","Whether this poll should not be shown in the main window.") }, "hideLabel": true, "checked": false, "name": "hidden", "selectOnFocus": true, "anchor": "-20" });
    var pub_date7 = new Ext.form.DisplayField({ "disabled": true, "fieldLabel": "Date published", "anchor": "-20", "value": "<br>", "name": "pub_date" });
    var main_2_panel8 = new Ext.Panel({ "autoScroll": false, "autoHeight": true, "border": false, "layout": "hbox", "labelWidth": 135, "hideCheckBoxLabels": true, "items": [ { "flex": 38, "autoHeight": true, "layout": "form", "xtype": "panel", "items": hidden6, "labelAlign": "top" }, { "flex": 61, "autoHeight": true, "layout": "form", "xtype": "panel", "items": pub_date7, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "labelAlign": "top" });
    var ChoicesByPoll_grid15 = new Lino.polls.ChoicesByPoll.GridPanel({ "flex": 71, "hide_top_toolbar": true, "containing_panel": this, "viewConfig": { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." }, "tools": [ Lino.show_in_own_window_button(Lino.polls.ChoicesByPoll.grid) ], "master_panel": this });
    var main_panel16 = new Ext.Panel({ "autoScroll": false, "border": false, "layout": "vbox", "hideCheckBoxLabels": true, "items": [ main_1_panel3, main_2_panel8, ChoicesByPoll_grid15 ], "frame": true, "layoutConfig": { "align": "stretch" }, "bodyBorder": false, "labelAlign": "top" });
    this.items = main_panel16;
    this.before_row_edit = function(record) {
      ChoicesByPoll_grid15.on_master_changed();
    }
...
// js_render_GridPanel_class polls.Polls
Lino.polls.Polls.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.Polls.detail;
    this.ls_insert_handler = Lino.polls.Polls.insert;
    var ww = this.containing_window;
    var id42 = new Ext.form.NumberField({ "selectOnFocus": true });
    var question43 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var hidden44 = new Ext.form.Checkbox({ "selectOnFocus": true, "checked": false });
    var pub_date45 = new Ext.form.DisplayField({ "disabled": true, "value": "<br>" });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id42, "width": Lino.chars2width(5), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "Question text", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "dataIndex": "question", "editor": question43 }, { "colIndex": 2, "sortable": false, "xtype": "checkcolumn", "header": "Hidden", "editable": true, "tooltip": "Whether this poll should not be shown in the main window.", "filter": { "type": "boolean" }, "width": Lino.chars2width(10), "dataIndex": "hidden" }, { "width": Lino.chars2width(16), "colIndex": 3, "sortable": true, "dataIndex": "pub_date", "header": "Date published", "editable": false } ];
    Lino.polls.Polls.GridPanel.superclass.initComponent.call(this);
  }
});


Lino.polls.Polls.insertPanel = Ext.extend(Lino.polls.Polls.InsertFormPanel,{
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.Polls.detail;
    this.ls_insert_handler = Lino.polls.Polls.insert;
    Lino.polls.Polls.insertPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.Polls.insert = new Lino.WindowAction({ "draggable": true, "width": Lino.chars2width(40), "autoHeight": true, "maximizable": true, "modal": true, "maximized": false },function(){
  var p = { "is_main_window": true, "hide_top_toolbar": true };
  return new Lino.polls.Polls.insertPanel(p);
});

Lino.polls.Polls.detailPanel = Ext.extend(Lino.polls.Polls.DetailFormPanel,{
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.Polls.detail;
    this.ls_insert_handler = Lino.polls.Polls.insert;
    Lino.polls.Polls.detailPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.Polls.detail = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.polls.Polls.detailPanel(p);
});
Lino.polls.Polls.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.polls.Polls.GridPanel(p);
});

// js_render_GridPanel_class polls.Choices
Lino.polls.Choices.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/polls/Choices",
  ls_bbar_actions : [ { "itemId": "vote", "menu_item_text": "vote", "must_save": true, "tooltip": "Click here to vote this.", "panel_btn_handler": Lino.row_action_handler('vote','GET'), "text": "vote", "overflowText": "vote", "auto_save": true } ],
  title : "Choices",
  gc_name : 0,
  stripeRows : true,
  ls_quick_edit : true,
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id47 = new Ext.form.NumberField({ "selectOnFocus": true });
    var poll48 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/polls/Choices/poll", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a Poll..." });
    var choice49 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var votes50 = new Ext.form.NumberField({ "selectOnFocus": true, "allowBlank": false, "value": 0 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id47, "width": Lino.chars2width(5), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "Poll", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "renderer": Lino.fk_renderer('pollHidden','Lino.polls.Polls.detail'), "editor": poll48, "dataIndex": "poll" }, { "colIndex": 2, "sortable": true, "header": "Choice text", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "dataIndex": "choice", "editor": choice49 }, new Lino.NullNumberColumn({ "colIndex": 3, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "No. of votes", "dataIndex": "votes", "width": Lino.chars2width(5), "editor": votes50 }) ];
    Lino.polls.Choices.GridPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.Choices.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
...
// js_render_GridPanel_class polls.ChoicesByPoll
Lino.polls.ChoicesByPoll.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id11 = new Ext.form.NumberField({ "selectOnFocus": true });
    var choice12 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var votes13 = new Ext.form.NumberField({ "selectOnFocus": true, "allowBlank": false, "value": 0 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ new Lino.NullNumberColumn({ "colIndex": 0, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id11, "width": Lino.chars2width(5), "dataIndex": "id" }), { "colIndex": 1, "sortable": true, "header": "Choice text", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "dataIndex": "choice", "editor": choice12 }, new Lino.NullNumberColumn({ "colIndex": 2, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "No. of votes", "dataIndex": "votes", "width": Lino.chars2width(5), "editor": votes13 }) ];
    Lino.polls.ChoicesByPoll.GridPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.ChoicesByPoll.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
...
Lino.about.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp52 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var name_disp53 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp54 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var rows55 = new Ext.form.NumberField({ "disabled": true });
    var detail_action_disp56 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.FieldsByModel.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var name_disp31 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var verbose_name_disp32 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    var help_text_column_disp33 = new Ext.form.DisplayField({ "disabled": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.about.SourceFiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var module_name58 = new Ext.form.TextField({ "disabled": true, "maxLength": null });
    var code_lines59 = new Ext.form.NumberField({ "disabled": true });
    var doc_lines60 = new Ext.form.NumberField({ "disabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.Genders.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value62 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name63 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text64 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.UserProfiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value66 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name67 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text68 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
...
Lino.lino.UserGroups.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value70 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name71 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text72 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
...
Lino.lino.UserLevels.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value74 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name75 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text76 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
