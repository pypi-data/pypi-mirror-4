	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 NaConductance /home/mattions/Dev/Neuronvisio/examples/cerebellum_network/hoc/x86_64/NaConductance.mod\n");
...
double vtrap ( _p, _ppvar, _thread, _nt, _lVminV0 , _lB ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lVminV0 , _lB ;
 {
   double _lvtrap;
