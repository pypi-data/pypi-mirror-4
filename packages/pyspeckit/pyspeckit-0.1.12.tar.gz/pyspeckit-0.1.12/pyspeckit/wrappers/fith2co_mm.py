...
Wrapper to fit formaldehyde *millimeter* spectra.  
"""
import pyspeckit
...
title_dict = {
    'threeohthree':'H$_2$CO 3$_{03}$-2$_{02}$', 
    'threetwotwo': 'H$_2$CO 3$_{22}$-2$_{21}$',
    'threetwoone': 'H$_2$CO 3$_{21}$-2$_{20}$'
    }
...
def plot_h2co(spdict,spectra, fignum=1, show_components=False, residfignum=None, **plotkwargs):
    ...
    if len(splist) == 2:
        axdict = { 'threeohthree':pyplot.subplot(211), 'threetwotwo':pyplot.subplot(212) }
    elif len(splist) == 3:
        axdict = { 'threeohthree':pyplot.subplot(211), 'threetwotwo':pyplot.subplot(223), 'threetwoone':pyplot.subplot(224), 'fourfour':pyplot.subplot(224) }
    elif len(splist) == 4:
        axdict = { 'threeohthree':pyplot.subplot(221), 'threetwotwo':pyplot.subplot(222), 'threetwoone':pyplot.subplot(223), 'fourfour':pyplot.subplot(224) }
    ...
    if spdict['threeohthree'].specfit.modelpars is not None:
        spdict['threeohthree'].specfit.annotate(labelspacing=0.05,prop={'size':'small','stretch':'extra-condensed'},frameon=False)
    ...
    spectra.plotter.axis = axdict['threeohthree']
    spectra.specfit.fitleg = spdict['threeohthree'].specfit.fitleg
