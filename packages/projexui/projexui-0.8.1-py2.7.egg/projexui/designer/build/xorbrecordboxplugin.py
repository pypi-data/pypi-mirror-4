...
from projexui.widgets.xorbrecordbox import XOrbRecordBox as WidgetClass

class XOrbRecordBoxPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbRecordBoxPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbrecordbox'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbRecordBox" name="XOrbRecordBox"/>'
