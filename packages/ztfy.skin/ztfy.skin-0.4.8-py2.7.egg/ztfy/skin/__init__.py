...
from ztfy.jqueryui import jquery, jquery_alerts, jquery_jsonrpc, jquery_tools, jquery_ui_base
...
ztfy_skin = Resource(library, 'js/ztfy.skin.js', minified='js/ztfy.skin.min.js',
                     depends=[ztfy_skin_css, jquery, jquery_ui_base, jquery_alerts, jquery_jsonrpc, jquery_tools])
