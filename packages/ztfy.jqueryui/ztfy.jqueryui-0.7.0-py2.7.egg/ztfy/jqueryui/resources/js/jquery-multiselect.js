  ...
  (function($) {
    ...
    $.MultiSelect.AutoComplete = (function() {
      ...
      AutoComplete.prototype._search = function() {
        var complete, def, i, item, option, x, _i, _len, _ref,
          _this = this;
        if (this.busy) {
          return;
        }
        ...
        if (this.query.present() && this.query.length >= this.multiselect.options.min_query_length) {
          ...
          if (this.multiselect.options.enable_new_options) {
            def = this.create_item($.MultiSelect.addLabel + " <em>" + this.query + "</em>");
          ...
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            ...
            $('em', item).each(function() {
              var _this = this;
              return $(this).mouseover(function(e) {
                var target;
                target = window.event ? window.event.srcElement : e.target;
                return complete.select_index($(target).parents('li').attr('multiselect:index'));
              });
            });
          }
          if (this.multiselect.options.enable_new_options) {
      ...
      AutoComplete.prototype.create_item = function(text, highlight) {
        ...
        $("em", item).each(function() {
          ...
          return $(this).click(function() {
            complete.multiselect.add_and_reset();
            complete.search();
            return complete.input.focus();
          });
        });
        return item;
      };
    ...
    return $(document).ready(function() {
      ...
      return $.getScript('/--static--/ztfy.jqueryui/js/i18n/' + lang + '.js', function() {
