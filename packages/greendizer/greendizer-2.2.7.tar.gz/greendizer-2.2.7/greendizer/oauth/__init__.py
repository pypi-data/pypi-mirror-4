...
class OAuthClient(object):
    ...
    def refresh_token(self, token, redirect_uri=None, scope=None, timeout=15):
        return self.__do_request('refresh_token', 'refresh_token', token,
                                 scope=scope, redirect_uri=redirect_uri,
                                 timeout=timeout)
    
    def obtain_token(self, code, redirect_uri=None, scope=None, timeout=15):
