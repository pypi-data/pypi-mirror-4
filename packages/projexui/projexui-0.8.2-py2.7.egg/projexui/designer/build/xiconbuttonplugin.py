...
from projexui.widgets.xiconbutton import XIconButton as WidgetClass

class XIconButtonPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XIconButtonPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xiconbutton'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XIconButton" name="XIconButton"/>'
