...
from projexui.widgets.xorbtreewidget import XOrbTreeWidget as WidgetClass

class XOrbTreeWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbTreeWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbtreewidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbTreeWidget" name="XOrbTreeWidget"/>'
