...
tester = Tester("source_rgb.png", 30)
...
tester.addTests([
                ...
                ("color.alphaMask", "modify-return",
                 pgext.color.alphaMask, [source_mask], source_rgba),
                ("color.alphaMask2", "modify-return",
                 pgext.color.alphaMask, [source_mask2, 1], source_rgba),


                ("filters.shadow", "modify-return",
                 pgext.filters.shadow, [(0, 0, 0), 5, 1, 0.9], source_rgba),
                ("filters.shadow2", "modify-return",
                 pgext.filters.shadow, [(200, 0, 0), 10, 0, 0.9], source_rgba),
                ...
                ("filters.ripple", "modify-inplace",
                 pgext.filters.ripple, [30, 4]),
