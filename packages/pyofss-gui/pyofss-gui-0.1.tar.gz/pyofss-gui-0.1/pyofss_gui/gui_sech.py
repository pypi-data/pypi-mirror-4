...
class GuiSech(QtGui.QWidget):
    """ Wrapper for pyofss.modules.sech. """
    def __init__(self):
        ...
        self.using_fwhm = QtGui.QComboBox()
        self.using_fwhm.addItems(QtCore.QStringList(["True", "False"]))
        self.using_fwhm.setCurrentIndex(1)
    ...
    def update_data(self):
        ...
        using_fwhm = (self.using_fwhm.currentText() == "True")

        self.data = {
            "name": name, "position": position, "width": width,
            "peak_power": peak_power, "offset_nu": offset_nu,
            "C": chirp, "initial_phase": initial_phase,
            "channel": channel, "using_fwhm": using_fwhm}

    def __call__(self):
        self.update_data()
        return Sech(**self.data)
