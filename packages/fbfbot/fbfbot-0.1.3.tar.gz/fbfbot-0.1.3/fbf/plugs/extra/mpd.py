...
#
# CHANGELOG
#  BHJTW 2012-09-15 - ported to FBFBOT
#
#  2011-02-20
...
from fbf.lib.fleet import fleet
...
class MPDWatcher(Pdod):
    """ the MPD watcher. """
    def __init__(self):
        Pdod.__init__(self, os.path.join(getdatadir() + os.sep + 'plugs' + os.sep + 'fbf.plugs.sockets.mpd', 'mpd'))
        self.running = False
        self.lastsong = -1
