...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RobotsTxt'
        db.create_table('asv_seo_robotstxt', (
        ...
        db.send_create_signal('asv_seo', ['RobotsTxt'])


    def backwards(self, orm):
        
        # Deleting model 'RobotsTxt'
        db.delete_table('asv_seo_robotstxt')
