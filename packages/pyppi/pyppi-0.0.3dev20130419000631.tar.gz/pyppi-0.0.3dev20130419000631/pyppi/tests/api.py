...
class PipTestCase(DjangoLiveServerPlugin, BaseTestMixin):
    def setUp(self):
    ...
    def test_priv_download(self):
        result = self._pip('install',
                           ...
                           secure=True)
        print result
        print 1111, result.files_before.keys()
        print 1111, result.files_after.keys()
        print 1111, result.files_created.keys()
