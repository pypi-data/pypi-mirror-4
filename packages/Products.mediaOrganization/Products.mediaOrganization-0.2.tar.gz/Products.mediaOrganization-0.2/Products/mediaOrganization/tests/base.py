...
def setup_product():
    ...
    import Products.mediaOrganization
    zcml.load_config('configure.zcml', Products.mediaOrganization)
    ...
    ztc.installPackage('Products.mediaOrganization')
...
setup_product()
ptc.setupPloneSite(products=['Products.mediaOrganization'])
