...
class CloudServersFG(Cloud):
    ...
    def getServers(self, details=False, attrDict={}):
        ...
        self.queryDict()
        log.info("getServers GET to %s" % self.endpoint)
        self.so_chk1()
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def getServer(self, sId):
        ...
        log.info("getServer GET to %s" % self.endpoint) 
        print self.endpoint
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def createServer(self, name, flavorId, imageId, attrDict={}):
        ...
        log.info("createServer POST to %s with data - %s" % (self.endpoint, str(self.postData)))
    ...
    def updateServer(self, sId, attrDict={}):
        ...
        log.info("updateServer PUT to %s with data - %s" % (self.endpoint, str(self.postData)))
    ...
    def deleteServer(self, sId):
        ...
        """
        self.baseURL('servers/'+str(sId)) 
        log.info("deleteServer DELETE to %s" % self.endpoint)
        self.so_chk1()
    ...
    def getAddresses(self, sId, network=None):
        ...
        log.info("getAddresses GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def shareAddress(self, sId, addr, attrDict={}):
        ...
        log.info("shareAddress PUT to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "PUT", self.postData)
    ...
    def unshareAddress(self, sId, addr):
        ...
        log.info("unshareAddress DELETE to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "DELETE")
    ...
    def _serverAction(self, sId, actionDict={}, returnResults=False):
        ...
        if self.postData == {}:
            log.info("_serverAction POST to %s" % self.endpoint)
            #print self.endpoint
            return self.apiRequest(self.endpoint, "POST", returnResults)
        else:
            log.info("_serverAction POST to %s with data - %s" % (self.endpoint, str(self.postData)))
            #print self.endpoint
            #print self.postData
            return self.apiRequest(self.endpoint, "POST", self.postData, returnResults)
    ...
    def getFlavors(self, details=False):
        ...
        log.info("getFlavors GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def getImages(self, details=False):
        ...
        log.info("getImages GET to %s" % self.endpoint) 
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def getImage(self, iId):
        ...
        log.info("getImage GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def deleteImage(self, iId):
        ...
        log.info("deleteImage DELETE to %s" % self.endpoint) 
        return self.apiRequest(self.endpoint, "DELETE")
    ...
    def createImage(self, sId, name):
        ...
        log.info("createImage POST to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "POST", self.postData, returnResults=True)
    ...
    def getBSchedule(self, sId):
        ...
        log.info("getBSchedule GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def setBSchedule(self, sId, attrDict={}):
        ...
        log.info("setBSchedule POST to %s with data - %s" % (self.endpoint, str(self.postData)))
    ...
    def disableBSchedule(self, sId):
        ...
        log.info("disableBSchedule DELETE to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "DELETE")
    ...
    def getIPGroups(self, details=False):
        ...
        log.info("getIPGroups GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def getIPGroup(self, gId):
        ...
        log.info("getIPGroup GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", returnResults=True)
    ...
    def deleteIPGroup(self, gId):
        ...
        log.info("deleteIPGroup DELETE to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "DELETE")
    ...
    def createIPGroup(self, gName, sId=None):
        ...
        log.info("createIPGroup POST to %s with data - %s" % (self.endpoint, str(self.postData)))
        return self.apiRequest(self.endpoint, "POST", self.postData, returnResults=True)
