...
class CloudDNS(Cloud):
    ...
    def createDomains(self, attrList, returnResults=False):
        ...
        return self.apiRequest( self.endpoint, "POST", self.postData, returnResults=returnResults)    
    ...
    def deleteDomains(self, domainList, deleteSubdomains=False, returnResults=False):
        ...
        return self.apiRequest( self.endpoint, "DELETE", returnResults=returnResults)
    ...
    def createRdns(self, recordList, serviceType, deviceUri):
        ...
        return self.apiRequest( endpoint, "POST", data, returnResults=True)
    ...
    def updateRdns(self, recordList, serviceType, deviceUri):
        ...
        return self.apiRequest( endpoint, "PUT", data, returnResults=True)
    ...
    def deleteRdns(self, serviceType, deviceUri, ip=None):
        ...
        return self.apiRequest( endpoint, "DELETE")
