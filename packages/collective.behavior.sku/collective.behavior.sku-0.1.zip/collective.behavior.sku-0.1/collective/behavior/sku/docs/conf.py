...
project = u'collective.behavior.sku'
...
htmlhelp_basename = 'collective.behavior.skudoc'
...
latex_documents = [
  ('index', 'collective.behavior.sku.tex', u'collective.behavior.sku Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.sku Documentation',
        [u'Taito Horiuchi'],
        1)]
