...
def find_optimset(diagnostic_headers_file, diagnostic_paths_file):
    ...
    diag_tree_desc_path=[
                            'center','model','experiment','frequency','realm','mip',
                            'rip','var','version','search','file_type'
                         ]
    paths_dict=valid_experiments.intersection_path(paths_dict,diag_tree_desc,diag_tree_desc_path)
...
def find_optimset_months(diagnostic_headers_file, diagnostic_paths_file, gzip_flag):
    import gzip
    import json
    import valid_experiments
    paths_dict=json.load(diagnostic_headers_file)
    ...
    diag_tree_desc_months=[
                            ...
                            'var','version','year','month','file_type','search'
                         ]
    paths_dict=valid_experiments.intersection_months(paths_dict,diag_tree_desc_path,diag_tree_desc_months)
...
def main():
    ...
    if options.command=='optimset':
        find_optimset(options.in_diagnostic_headers_file, options.out_paths_file)
    if options.command=='optimset_months':
        find_optimset_months(options.in_diagnostic_headers_file, options.out_paths_file, options.gzip)
