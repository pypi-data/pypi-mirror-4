...
typedef struct _MatcherT__isset {
  _MatcherT__isset() : id(false), type(false), field(false), value(false) {}
  bool id;
  bool type;
  bool field;
  bool value;
...
class MatcherT {
 public:
  ...
  MatcherT() : id(), type((MatcherType::type)0), field((MatcherField::type)0), value() {
  }
...
class FilterT {
 public:
  ...
  static const char* ascii_fingerprint; // = "89751F0E4A83B7607CA9F2A91635B8FA";
  static const uint8_t binary_fingerprint[16]; // = {0x89,0x75,0x1F,0x0E,0x4A,0x83,0xB7,0x60,0x7C,0xA9,0xF2,0xA9,0x16,0x35,0xB8,0xFA};
...
typedef struct _LayerSpecT__isset {
  _LayerSpecT__isset() : name(false), command(false), tags(false), range(false), chunk(true), minCores(true), maxCores(true), minRamMb(true), threadable(true), depends(false), tasks(false) {}
  bool name;
  bool command;
  bool tags;
  bool range;
...
class LayerSpecT {
 public:
  ...
  static const char* ascii_fingerprint; // = "04AF60036B8610D0BCFEA2D559A5D2CB";
  static const uint8_t binary_fingerprint[16]; // = {0x04,0xAF,0x60,0x03,0x6B,0x86,0x10,0xD0,0xBC,0xFE,0xA2,0xD5,0x59,0xA5,0xD2,0xCB};
...
typedef struct _JobSpecT__isset {
  _JobSpecT__isset() : name(false), project(false), paused(false), username(false), uid(false), logPath(false), layers(false), depends(false), attrs(false) {}
  bool name;
  bool project;
  bool paused;
  bool username;
...
class JobSpecT {
 public:
  ...
  static const char* ascii_fingerprint; // = "C047168B7917FDB98284A37B1432E498";
  static const uint8_t binary_fingerprint[16]; // = {0xC0,0x47,0x16,0x8B,0x79,0x17,0xFD,0xB9,0x82,0x84,0xA3,0x7B,0x14,0x32,0xE4,0x98};
...
class JobFilterT {
 public:
  ...
  static const char* ascii_fingerprint; // = "E204315B1138B8CA5BF66F593C7CC089";
  static const uint8_t binary_fingerprint[16]; // = {0xE2,0x04,0x31,0x5B,0x11,0x38,0xB8,0xCA,0x5B,0xF6,0x6F,0x59,0x3C,0x7C,0xC0,0x89};
  ...
  bool operator == (const JobFilterT & rhs) const
  {
    ...
    if (__isset.states != rhs.__isset.states)
      ...
      return false;
    if (__isset.jobIds != rhs.__isset.jobIds)
      return false;
    else if (__isset.jobIds && !(jobIds == rhs.jobIds))
      return false;
