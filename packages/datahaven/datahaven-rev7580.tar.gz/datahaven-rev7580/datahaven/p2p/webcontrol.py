...
class SecurityPage(Page):
    ...
    def renderPage(self, request):
        ...
        src += '<p>You can create <b>a completely inaccessible for anybody but you</b>, keeping your data, if after creating a distributed remote backup - delete the original data. '
        ...
        src += 'After starting the program, disconnect the USB flash drive, and hide in a safe place.</p>\n'
        src += '<p>If control of the computer was lost - just <b>be sure that the power is turned off</b>, it is easy to provide. '
        src += 'In this case the memory is reset and working key will be erased, so that copy of your Key will remain only on a flash drive, hidden by you.</p>\n'
