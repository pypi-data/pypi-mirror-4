...
library = Library('kotti_theme_amelia', 'static')
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_amelia.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_amelia.edit_needed'