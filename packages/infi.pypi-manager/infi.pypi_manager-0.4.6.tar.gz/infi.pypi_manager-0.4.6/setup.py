...
SETUP_INFO = dict(
    ...
    install_requires = ['infi.pyutils', 'infi.execute', 'distribute', 'docopt'],
    ...
    entry_points = dict(
        console_scripts = ['mirror_package = infi.pypi_manager.scripts:mirror_package', 'hard_install = infi.pypi_manager.scripts.hard_install:main'],
        gui_scripts = [],
        ),
)
