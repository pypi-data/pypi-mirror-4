...
from fbf.lib.errors import NoSuchWave
from fbf.utils.exception import handle_exception
from fbf.utils.generic import stripcolor
...
examples.add('relay', 'open a relay to another user/channel', '1) relay default-sxmpp sxmpp feedbackloop@gmail.com 2) relay botfather')
