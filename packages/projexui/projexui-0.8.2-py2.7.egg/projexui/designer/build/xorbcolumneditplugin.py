...
from projexui.widgets.xorbcolumnedit import XOrbColumnEdit as WidgetClass

class XOrbColumnEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbColumnEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbcolumnedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbColumnEdit" name="XOrbColumnEdit"/>'
