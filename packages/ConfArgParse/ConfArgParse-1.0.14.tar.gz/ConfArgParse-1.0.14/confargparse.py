...
class ConfArgParser(argparse.ArgumentParser):
    def __init__(self, *args, **kwargs):
        ...
        self.callback = kwargs.get("callback", lambda opt: True)
    ...
    def _parse_config(self, args):
        ...
        if args.conf_file:
            ...
            while True:
                ...
                namespace = argparse.Namespace(**config_options)
                if self.callback(self, namespace):
                    break
