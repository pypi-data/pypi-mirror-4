...
defaults = {
    'version': '0.95rc4',   # TODO: fetch from global somewhere?
    'author': 'Walter Doekes',
    'author_email': 'wjdoekes+pstore@osso.nl',
    'url': 'https://code.osso.nl/projects/pstore/',           # fix later
    'download_url': 'https://code.osso.nl/projects/pstore/',  # fix later
    'license': 'LGPLv3',
