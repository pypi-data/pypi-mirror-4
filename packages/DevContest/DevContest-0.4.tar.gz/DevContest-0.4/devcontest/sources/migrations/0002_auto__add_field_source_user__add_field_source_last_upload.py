...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.user'
        db.add_column('sources_source', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Source.last_upload'
        db.add_column('sources_source', 'last_upload',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 7, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.user'
        db.delete_column('sources_source', 'user_id')

        # Deleting field 'Source.last_upload'
        db.delete_column('sources_source', 'last_upload')
    ...
    models = {
        ...
        'sources.source': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sources.Language']"}),
            'last_upload': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
