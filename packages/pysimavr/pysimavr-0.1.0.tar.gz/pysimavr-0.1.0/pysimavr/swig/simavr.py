...
def AVR_IOCTL_IOPORT_GETIRQ(*args):
  return _simavr.AVR_IOCTL_IOPORT_GETIRQ(*args)
AVR_IOCTL_IOPORT_GETIRQ = _simavr.AVR_IOCTL_IOPORT_GETIRQ

def get_irq_at(*args):
  return _simavr.get_irq_at(*args)
get_irq_at = _simavr.get_irq_at

def avr_thread(*args):
  return _simavr.avr_thread(*args)
avr_thread = _simavr.avr_thread

def avr_start_thread(*args):
  return _simavr.avr_start_thread(*args)
...
def avr_step_thread(*args):
  return _simavr.avr_step_thread(*args)
avr_step_thread = _simavr.avr_step_thread

def avr_fpeek(*args):
  return _simavr.avr_fpeek(*args)
avr_fpeek = _simavr.avr_fpeek

def avr_peek(*args):
  return _simavr.avr_peek(*args)
avr_peek = _simavr.avr_peek

def avr_thread_goto_cycle(*args):
  return _simavr.avr_thread_goto_cycle(*args)
...
class avr_regbit_t(_object):
    ...
    if _newclass:reg = _swig_property(_simavr.avr_regbit_t_reg_get, _simavr.avr_regbit_t_reg_set)
    __swig_setmethods__["bit"] = _simavr.avr_regbit_t_bit_set
    __swig_getmethods__["bit"] = _simavr.avr_regbit_t_bit_get
    if _newclass:bit = _swig_property(_simavr.avr_regbit_t_bit_get, _simavr.avr_regbit_t_bit_set)
    __swig_setmethods__["mask"] = _simavr.avr_regbit_t_mask_set
    __swig_getmethods__["mask"] = _simavr.avr_regbit_t_mask_get
    if _newclass:mask = _swig_property(_simavr.avr_regbit_t_mask_get, _simavr.avr_regbit_t_mask_set)
    def __init__(self): 
...
class avr_irq_pool_t(_object):
    ...
    if _newclass:count = _swig_property(_simavr.avr_irq_pool_t_count_get, _simavr.avr_irq_pool_t_count_set)
    __swig_setmethods__["irq"] = _simavr.avr_irq_pool_t_irq_set
    __swig_getmethods__["irq"] = _simavr.avr_irq_pool_t_irq_get
    if _newclass:irq = _swig_property(_simavr.avr_irq_pool_t_irq_get, _simavr.avr_irq_pool_t_irq_set)
    def __init__(self): 
...
class avr_irq_t(_object):
    ...
    if _newclass:pool = _swig_property(_simavr.avr_irq_t_pool_get, _simavr.avr_irq_t_pool_set)
    __swig_setmethods__["name"] = _simavr.avr_irq_t_name_set
    __swig_getmethods__["name"] = _simavr.avr_irq_t_name_get
    if _newclass:name = _swig_property(_simavr.avr_irq_t_name_get, _simavr.avr_irq_t_name_set)
    __swig_setmethods__["irq"] = _simavr.avr_irq_t_irq_set
    __swig_getmethods__["irq"] = _simavr.avr_irq_t_irq_get
    if _newclass:irq = _swig_property(_simavr.avr_irq_t_irq_get, _simavr.avr_irq_t_irq_set)
    __swig_setmethods__["value"] = _simavr.avr_irq_t_value_set
    __swig_getmethods__["value"] = _simavr.avr_irq_t_value_get
    if _newclass:value = _swig_property(_simavr.avr_irq_t_value_get, _simavr.avr_irq_t_value_set)
    __swig_setmethods__["flags"] = _simavr.avr_irq_t_flags_set
    __swig_getmethods__["flags"] = _simavr.avr_irq_t_flags_get
    if _newclass:flags = _swig_property(_simavr.avr_irq_t_flags_get, _simavr.avr_irq_t_flags_set)
    __swig_setmethods__["hook"] = _simavr.avr_irq_t_hook_set
    __swig_getmethods__["hook"] = _simavr.avr_irq_t_hook_get
    if _newclass:hook = _swig_property(_simavr.avr_irq_t_hook_get, _simavr.avr_irq_t_hook_set)
    def __init__(self): 
...
def avr_alloc_irq(*args):
  return _simavr.avr_alloc_irq(*args)
avr_alloc_irq = _simavr.avr_alloc_irq

def avr_free_irq(*args):
  return _simavr.avr_free_irq(*args)
avr_free_irq = _simavr.avr_free_irq

def avr_init_irq(*args):
  return _simavr.avr_init_irq(*args)
avr_init_irq = _simavr.avr_init_irq

def avr_raise_irq(*args):
  return _simavr.avr_raise_irq(*args)
avr_raise_irq = _simavr.avr_raise_irq

def avr_connect_irq(*args):
  return _simavr.avr_connect_irq(*args)
avr_connect_irq = _simavr.avr_connect_irq

def avr_unconnect_irq(*args):
  return _simavr.avr_unconnect_irq(*args)
avr_unconnect_irq = _simavr.avr_unconnect_irq

def avr_irq_register_notify(*args):
  return _simavr.avr_irq_register_notify(*args)
avr_irq_register_notify = _simavr.avr_irq_register_notify

def avr_irq_unregister_notify(*args):
  return _simavr.avr_irq_unregister_notify(*args)
...
class avr_io_t(_object):
    ...
    if _newclass:next = _swig_property(_simavr.avr_io_t_next_get, _simavr.avr_io_t_next_set)
    __swig_setmethods__["avr"] = _simavr.avr_io_t_avr_set
    __swig_getmethods__["avr"] = _simavr.avr_io_t_avr_get
    if _newclass:avr = _swig_property(_simavr.avr_io_t_avr_get, _simavr.avr_io_t_avr_set)
    __swig_setmethods__["kind"] = _simavr.avr_io_t_kind_set
    __swig_getmethods__["kind"] = _simavr.avr_io_t_kind_get
    if _newclass:kind = _swig_property(_simavr.avr_io_t_kind_get, _simavr.avr_io_t_kind_set)
    __swig_setmethods__["irq_names"] = _simavr.avr_io_t_irq_names_set
    __swig_getmethods__["irq_names"] = _simavr.avr_io_t_irq_names_get
    if _newclass:irq_names = _swig_property(_simavr.avr_io_t_irq_names_get, _simavr.avr_io_t_irq_names_set)
    ...
    if _newclass:irq_ioctl_get = _swig_property(_simavr.avr_io_t_irq_ioctl_get_get, _simavr.avr_io_t_irq_ioctl_get_set)
    __swig_setmethods__["irq_count"] = _simavr.avr_io_t_irq_count_set
    __swig_getmethods__["irq_count"] = _simavr.avr_io_t_irq_count_get
    if _newclass:irq_count = _swig_property(_simavr.avr_io_t_irq_count_get, _simavr.avr_io_t_irq_count_set)
    __swig_setmethods__["irq"] = _simavr.avr_io_t_irq_set
    __swig_getmethods__["irq"] = _simavr.avr_io_t_irq_get
    if _newclass:irq = _swig_property(_simavr.avr_io_t_irq_get, _simavr.avr_io_t_irq_set)
    __swig_setmethods__["reset"] = _simavr.avr_io_t_reset_set
    __swig_getmethods__["reset"] = _simavr.avr_io_t_reset_get
    if _newclass:reset = _swig_property(_simavr.avr_io_t_reset_get, _simavr.avr_io_t_reset_set)
    __swig_setmethods__["ioctl"] = _simavr.avr_io_t_ioctl_set
    __swig_getmethods__["ioctl"] = _simavr.avr_io_t_ioctl_get
    if _newclass:ioctl = _swig_property(_simavr.avr_io_t_ioctl_get, _simavr.avr_io_t_ioctl_set)
    __swig_setmethods__["dealloc"] = _simavr.avr_io_t_dealloc_set
    __swig_getmethods__["dealloc"] = _simavr.avr_io_t_dealloc_get
    if _newclass:dealloc = _swig_property(_simavr.avr_io_t_dealloc_get, _simavr.avr_io_t_dealloc_set)
    def __init__(self): 
...
def avr_register_io(*args):
  return _simavr.avr_register_io(*args)
avr_register_io = _simavr.avr_register_io

def avr_io_setirqs(*args):
  return _simavr.avr_io_setirqs(*args)
avr_io_setirqs = _simavr.avr_io_setirqs

def avr_register_io_read(*args):
  return _simavr.avr_register_io_read(*args)
avr_register_io_read = _simavr.avr_register_io_read

def avr_register_io_write(*args):
  return _simavr.avr_register_io_write(*args)
avr_register_io_write = _simavr.avr_register_io_write

def avr_ioctl(*args):
  return _simavr.avr_ioctl(*args)
avr_ioctl = _simavr.avr_ioctl

def avr_io_getirq(*args):
  return _simavr.avr_io_getirq(*args)
avr_io_getirq = _simavr.avr_io_getirq
AVR_IOMEM_IRQ_ALL = _simavr.AVR_IOMEM_IRQ_ALL

def avr_iomem_getirq(*args):
  return _simavr.avr_iomem_getirq(*args)
avr_iomem_getirq = _simavr.avr_iomem_getirq

def avr_deallocate_ios(*args):
  return _simavr.avr_deallocate_ios(*args)
...
class avr_trace_data_t(_object):
    ...
    if _newclass:codeline = _swig_property(_simavr.avr_trace_data_t_codeline_get, _simavr.avr_trace_data_t_codeline_set)
    ...
    if _newclass:old_pci = _swig_property(_simavr.avr_trace_data_t_old_pci_get, _simavr.avr_trace_data_t_old_pci_set)
    ...
    if _newclass:touched = _swig_property(_simavr.avr_trace_data_t_touched_get, _simavr.avr_trace_data_t_touched_set)
    __swig_getmethods__["old"] = _simavr.avr_trace_data_t_old_get
    if _newclass:old = _swig_property(_simavr.avr_trace_data_t_old_get)
    def __init__(self): 
...
class avr_trace_data_t_old(_object):
    ...
    if _newclass:pc = _swig_property(_simavr.avr_trace_data_t_old_pc_get, _simavr.avr_trace_data_t_old_pc_set)
    __swig_setmethods__["sp"] = _simavr.avr_trace_data_t_old_sp_set
    __swig_getmethods__["sp"] = _simavr.avr_trace_data_t_old_sp_get
    if _newclass:sp = _swig_property(_simavr.avr_trace_data_t_old_sp_get, _simavr.avr_trace_data_t_old_sp_set)
    def __init__(self): 
...
class avr_t(_object):
    ...
    if _newclass:mmcu = _swig_property(_simavr.avr_t_mmcu_get, _simavr.avr_t_mmcu_set)
    __swig_setmethods__["ramend"] = _simavr.avr_t_ramend_set
    __swig_getmethods__["ramend"] = _simavr.avr_t_ramend_get
    if _newclass:ramend = _swig_property(_simavr.avr_t_ramend_get, _simavr.avr_t_ramend_set)
    __swig_setmethods__["flashend"] = _simavr.avr_t_flashend_set
    __swig_getmethods__["flashend"] = _simavr.avr_t_flashend_get
    if _newclass:flashend = _swig_property(_simavr.avr_t_flashend_get, _simavr.avr_t_flashend_set)
    __swig_setmethods__["e2end"] = _simavr.avr_t_e2end_set
    __swig_getmethods__["e2end"] = _simavr.avr_t_e2end_get
    if _newclass:e2end = _swig_property(_simavr.avr_t_e2end_get, _simavr.avr_t_e2end_set)
    ...
    if _newclass:vector_size = _swig_property(_simavr.avr_t_vector_size_get, _simavr.avr_t_vector_size_set)
    __swig_setmethods__["signature"] = _simavr.avr_t_signature_set
    __swig_getmethods__["signature"] = _simavr.avr_t_signature_get
    if _newclass:signature = _swig_property(_simavr.avr_t_signature_get, _simavr.avr_t_signature_set)
    __swig_setmethods__["fuse"] = _simavr.avr_t_fuse_set
    __swig_getmethods__["fuse"] = _simavr.avr_t_fuse_get
    if _newclass:fuse = _swig_property(_simavr.avr_t_fuse_get, _simavr.avr_t_fuse_set)
    __swig_setmethods__["rampz"] = _simavr.avr_t_rampz_set
    __swig_getmethods__["rampz"] = _simavr.avr_t_rampz_get
    if _newclass:rampz = _swig_property(_simavr.avr_t_rampz_get, _simavr.avr_t_rampz_set)
    __swig_setmethods__["eind"] = _simavr.avr_t_eind_set
    __swig_getmethods__["eind"] = _simavr.avr_t_eind_get
    if _newclass:eind = _swig_property(_simavr.avr_t_eind_get, _simavr.avr_t_eind_set)
    __swig_setmethods__["codeend"] = _simavr.avr_t_codeend_set
    __swig_getmethods__["codeend"] = _simavr.avr_t_codeend_get
    if _newclass:codeend = _swig_property(_simavr.avr_t_codeend_get, _simavr.avr_t_codeend_set)
    __swig_setmethods__["state"] = _simavr.avr_t_state_set
    __swig_getmethods__["state"] = _simavr.avr_t_state_get
    if _newclass:state = _swig_property(_simavr.avr_t_state_get, _simavr.avr_t_state_set)
    __swig_setmethods__["frequency"] = _simavr.avr_t_frequency_set
    __swig_getmethods__["frequency"] = _simavr.avr_t_frequency_get
    if _newclass:frequency = _swig_property(_simavr.avr_t_frequency_get, _simavr.avr_t_frequency_set)
    __swig_setmethods__["vcc"] = _simavr.avr_t_vcc_set
    __swig_getmethods__["vcc"] = _simavr.avr_t_vcc_get
    if _newclass:vcc = _swig_property(_simavr.avr_t_vcc_get, _simavr.avr_t_vcc_set)
    __swig_setmethods__["avcc"] = _simavr.avr_t_avcc_set
    __swig_getmethods__["avcc"] = _simavr.avr_t_avcc_get
    if _newclass:avcc = _swig_property(_simavr.avr_t_avcc_get, _simavr.avr_t_avcc_set)
    __swig_setmethods__["aref"] = _simavr.avr_t_aref_set
    __swig_getmethods__["aref"] = _simavr.avr_t_aref_get
    if _newclass:aref = _swig_property(_simavr.avr_t_aref_get, _simavr.avr_t_aref_set)
    __swig_setmethods__["cycle"] = _simavr.avr_t_cycle_set
    __swig_getmethods__["cycle"] = _simavr.avr_t_cycle_get
    if _newclass:cycle = _swig_property(_simavr.avr_t_cycle_get, _simavr.avr_t_cycle_set)
    __swig_setmethods__["sleep_usec"] = _simavr.avr_t_sleep_usec_set
    __swig_getmethods__["sleep_usec"] = _simavr.avr_t_sleep_usec_get
    if _newclass:sleep_usec = _swig_property(_simavr.avr_t_sleep_usec_get, _simavr.avr_t_sleep_usec_set)
    __swig_setmethods__["init"] = _simavr.avr_t_init_set
    __swig_getmethods__["init"] = _simavr.avr_t_init_get
    if _newclass:init = _swig_property(_simavr.avr_t_init_get, _simavr.avr_t_init_set)
    __swig_setmethods__["special_init"] = _simavr.avr_t_special_init_set
    __swig_getmethods__["special_init"] = _simavr.avr_t_special_init_get
    if _newclass:special_init = _swig_property(_simavr.avr_t_special_init_get, _simavr.avr_t_special_init_set)
    __swig_setmethods__["special_deinit"] = _simavr.avr_t_special_deinit_set
    __swig_getmethods__["special_deinit"] = _simavr.avr_t_special_deinit_get
    if _newclass:special_deinit = _swig_property(_simavr.avr_t_special_deinit_get, _simavr.avr_t_special_deinit_set)
    __swig_setmethods__["reset"] = _simavr.avr_t_reset_set
    __swig_getmethods__["reset"] = _simavr.avr_t_reset_get
    if _newclass:reset = _swig_property(_simavr.avr_t_reset_get, _simavr.avr_t_reset_set)
    __swig_setmethods__["run"] = _simavr.avr_t_run_set
    __swig_getmethods__["run"] = _simavr.avr_t_run_get
    if _newclass:run = _swig_property(_simavr.avr_t_run_get, _simavr.avr_t_run_set)
    __swig_setmethods__["sleep"] = _simavr.avr_t_sleep_set
    __swig_getmethods__["sleep"] = _simavr.avr_t_sleep_get
    if _newclass:sleep = _swig_property(_simavr.avr_t_sleep_get, _simavr.avr_t_sleep_set)
    __swig_setmethods__["irq_pool"] = _simavr.avr_t_irq_pool_set
    __swig_getmethods__["irq_pool"] = _simavr.avr_t_irq_pool_get
    if _newclass:irq_pool = _swig_property(_simavr.avr_t_irq_pool_get, _simavr.avr_t_irq_pool_set)
    __swig_setmethods__["sreg"] = _simavr.avr_t_sreg_set
    __swig_getmethods__["sreg"] = _simavr.avr_t_sreg_get
    if _newclass:sreg = _swig_property(_simavr.avr_t_sreg_get, _simavr.avr_t_sreg_set)
    __swig_setmethods__["i_shadow"] = _simavr.avr_t_i_shadow_set
    __swig_getmethods__["i_shadow"] = _simavr.avr_t_i_shadow_get
    if _newclass:i_shadow = _swig_property(_simavr.avr_t_i_shadow_get, _simavr.avr_t_i_shadow_set)
    __swig_setmethods__["pc"] = _simavr.avr_t_pc_set
    __swig_getmethods__["pc"] = _simavr.avr_t_pc_get
    if _newclass:pc = _swig_property(_simavr.avr_t_pc_get, _simavr.avr_t_pc_set)
    ...
    if _newclass:io_shared_io_count = _swig_property(_simavr.avr_t_io_shared_io_count_get, _simavr.avr_t_io_shared_io_count_set)
    __swig_setmethods__["flash"] = _simavr.avr_t_flash_set
    __swig_getmethods__["flash"] = _simavr.avr_t_flash_get
    if _newclass:flash = _swig_property(_simavr.avr_t_flash_get, _simavr.avr_t_flash_set)
    __swig_setmethods__["data"] = _simavr.avr_t_data_set
    __swig_getmethods__["data"] = _simavr.avr_t_data_get
    if _newclass:data = _swig_property(_simavr.avr_t_data_get, _simavr.avr_t_data_set)
    __swig_setmethods__["io_port"] = _simavr.avr_t_io_port_set
    __swig_getmethods__["io_port"] = _simavr.avr_t_io_port_get
    if _newclass:io_port = _swig_property(_simavr.avr_t_io_port_get, _simavr.avr_t_io_port_set)
...
class avr_t_io_shared_io(_object):
    ...
    if _newclass:used = _swig_property(_simavr.avr_t_io_shared_io_used_get, _simavr.avr_t_io_shared_io_used_set)
    __swig_getmethods__["io"] = _simavr.avr_t_io_shared_io_io_get
    if _newclass:io = _swig_property(_simavr.avr_t_io_shared_io_io_get)
    def __init__(self): 
...
class avr_t_io_shared_io_io(_object):
    ...
    if _newclass:param = _swig_property(_simavr.avr_t_io_shared_io_io_param_get, _simavr.avr_t_io_shared_io_io_param_set)
    __swig_setmethods__["c"] = _simavr.avr_t_io_shared_io_io_c_set
    __swig_getmethods__["c"] = _simavr.avr_t_io_shared_io_io_c_get
    if _newclass:c = _swig_property(_simavr.avr_t_io_shared_io_io_c_get, _simavr.avr_t_io_shared_io_io_c_set)
    def __init__(self): 
...
class avr_t_io(_object):
    ...
    if _newclass:irq = _swig_property(_simavr.avr_t_io_irq_get, _simavr.avr_t_io_irq_set)
    __swig_getmethods__["r"] = _simavr.avr_t_io_r_get
    if _newclass:r = _swig_property(_simavr.avr_t_io_r_get)
    __swig_getmethods__["w"] = _simavr.avr_t_io_w_get
    if _newclass:w = _swig_property(_simavr.avr_t_io_w_get)
    def __init__(self): 
...
class avr_t_io_w(_object):
    ...
    if _newclass:param = _swig_property(_simavr.avr_t_io_w_param_get, _simavr.avr_t_io_w_param_set)
    __swig_setmethods__["c"] = _simavr.avr_t_io_w_c_set
    __swig_getmethods__["c"] = _simavr.avr_t_io_w_c_get
    if _newclass:c = _swig_property(_simavr.avr_t_io_w_c_get, _simavr.avr_t_io_w_c_set)
    def __init__(self): 
...
class avr_t_io_r(_object):
    ...
    if _newclass:param = _swig_property(_simavr.avr_t_io_r_param_get, _simavr.avr_t_io_r_param_set)
    __swig_setmethods__["c"] = _simavr.avr_t_io_r_c_set
    __swig_getmethods__["c"] = _simavr.avr_t_io_r_c_get
    if _newclass:c = _swig_property(_simavr.avr_t_io_r_c_get, _simavr.avr_t_io_r_c_set)
    def __init__(self): 
...
class avr_kind_t(_object):
    ...
    if _newclass:names = _swig_property(_simavr.avr_kind_t_names_get, _simavr.avr_kind_t_names_set)
    __swig_setmethods__["make"] = _simavr.avr_kind_t_make_set
    __swig_getmethods__["make"] = _simavr.avr_kind_t_make_get
    if _newclass:make = _swig_property(_simavr.avr_kind_t_make_get, _simavr.avr_kind_t_make_set)
    def __init__(self): 
...
class avr_symbol_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["symbol"] = _simavr.avr_symbol_t_symbol_set
    __swig_getmethods__["symbol"] = _simavr.avr_symbol_t_symbol_get
    if _newclass:symbol = _swig_property(_simavr.avr_symbol_t_symbol_get, _simavr.avr_symbol_t_symbol_set)
    __swig_setmethods__["addr"] = _simavr.avr_symbol_t_addr_set
    __swig_getmethods__["addr"] = _simavr.avr_symbol_t_addr_get
    if _newclass:addr = _swig_property(_simavr.avr_symbol_t_addr_get, _simavr.avr_symbol_t_addr_set)
    def __init__(self): 
...
def avr_make_mcu_by_name(*args):
  return _simavr.avr_make_mcu_by_name(*args)
avr_make_mcu_by_name = _simavr.avr_make_mcu_by_name

def avr_init(*args):
  return _simavr.avr_init(*args)
avr_init = _simavr.avr_init

def avr_core_allocate(*args):
  return _simavr.avr_core_allocate(*args)
avr_core_allocate = _simavr.avr_core_allocate

def avr_reset(*args):
  return _simavr.avr_reset(*args)
avr_reset = _simavr.avr_reset

def avr_run(*args):
  return _simavr.avr_run(*args)
avr_run = _simavr.avr_run

def avr_terminate(*args):
  return _simavr.avr_terminate(*args)
avr_terminate = _simavr.avr_terminate

def avr_set_command_register(*args):
  return _simavr.avr_set_command_register(*args)
avr_set_command_register = _simavr.avr_set_command_register

def avr_set_console_register(*args):
  return _simavr.avr_set_console_register(*args)
avr_set_console_register = _simavr.avr_set_console_register

def avr_loadcode(*args):
  return _simavr.avr_loadcode(*args)
avr_loadcode = _simavr.avr_loadcode

def avr_core_watch_write(*args):
  return _simavr.avr_core_watch_write(*args)
avr_core_watch_write = _simavr.avr_core_watch_write

def avr_core_watch_read(*args):
  return _simavr.avr_core_watch_read(*args)
avr_core_watch_read = _simavr.avr_core_watch_read

def avr_sadly_crashed(*args):
  return _simavr.avr_sadly_crashed(*args)
avr_sadly_crashed = _simavr.avr_sadly_crashed

def avr_callback_sleep_gdb(*args):
  return _simavr.avr_callback_sleep_gdb(*args)
avr_callback_sleep_gdb = _simavr.avr_callback_sleep_gdb

def avr_callback_run_gdb(*args):
  return _simavr.avr_callback_run_gdb(*args)
avr_callback_run_gdb = _simavr.avr_callback_run_gdb

def avr_callback_sleep_raw(*args):
  return _simavr.avr_callback_sleep_raw(*args)
avr_callback_sleep_raw = _simavr.avr_callback_sleep_raw

def avr_callback_run_raw(*args):
  return _simavr.avr_callback_run_raw(*args)
...
class avr_ioport_getirq_t(_object):
    ...
    if _newclass:bit = _swig_property(_simavr.avr_ioport_getirq_t_bit_get, _simavr.avr_ioport_getirq_t_bit_set)
    __swig_setmethods__["irq"] = _simavr.avr_ioport_getirq_t_irq_set
    __swig_getmethods__["irq"] = _simavr.avr_ioport_getirq_t_irq_get
    if _newclass:irq = _swig_property(_simavr.avr_ioport_getirq_t_irq_get, _simavr.avr_ioport_getirq_t_irq_set)
    def __init__(self): 
...
class avr_ioport_state_t(_object):
    ...
    if _newclass:name = _swig_property(_simavr.avr_ioport_state_t_name_get, _simavr.avr_ioport_state_t_name_set)
    __swig_setmethods__["port"] = _simavr.avr_ioport_state_t_port_set
    __swig_getmethods__["port"] = _simavr.avr_ioport_state_t_port_get
    if _newclass:port = _swig_property(_simavr.avr_ioport_state_t_port_get, _simavr.avr_ioport_state_t_port_set)
    __swig_setmethods__["ddr"] = _simavr.avr_ioport_state_t_ddr_set
    __swig_getmethods__["ddr"] = _simavr.avr_ioport_state_t_ddr_get
    if _newclass:ddr = _swig_property(_simavr.avr_ioport_state_t_ddr_get, _simavr.avr_ioport_state_t_ddr_set)
    __swig_setmethods__["pin"] = _simavr.avr_ioport_state_t_pin_set
    __swig_getmethods__["pin"] = _simavr.avr_ioport_state_t_pin_get
    if _newclass:pin = _swig_property(_simavr.avr_ioport_state_t_pin_get, _simavr.avr_ioport_state_t_pin_set)
    def __init__(self): 
...
class avr_iopin_t(_object):
    ...
    if _newclass:port = _swig_property(_simavr.avr_iopin_t_port_get, _simavr.avr_iopin_t_port_set)
    __swig_setmethods__["pin"] = _simavr.avr_iopin_t_pin_set
    __swig_getmethods__["pin"] = _simavr.avr_iopin_t_pin_get
    if _newclass:pin = _swig_property(_simavr.avr_iopin_t_pin_get, _simavr.avr_iopin_t_pin_set)
    def __init__(self): 
...
def avr_ioport_init(*args):
  return _simavr.avr_ioport_init(*args)
...
class elf_firmware_t(_object):
    ...
    if _newclass:mmcu = _swig_property(_simavr.elf_firmware_t_mmcu_get, _simavr.elf_firmware_t_mmcu_set)
    ...
    if _newclass:frequency = _swig_property(_simavr.elf_firmware_t_frequency_get, _simavr.elf_firmware_t_frequency_set)
    __swig_setmethods__["vcc"] = _simavr.elf_firmware_t_vcc_set
    __swig_getmethods__["vcc"] = _simavr.elf_firmware_t_vcc_get
    if _newclass:vcc = _swig_property(_simavr.elf_firmware_t_vcc_get, _simavr.elf_firmware_t_vcc_set)
    __swig_setmethods__["avcc"] = _simavr.elf_firmware_t_avcc_set
    __swig_getmethods__["avcc"] = _simavr.elf_firmware_t_avcc_get
    if _newclass:avcc = _swig_property(_simavr.elf_firmware_t_avcc_get, _simavr.elf_firmware_t_avcc_set)
    __swig_setmethods__["aref"] = _simavr.elf_firmware_t_aref_set
    __swig_getmethods__["aref"] = _simavr.elf_firmware_t_aref_get
    if _newclass:aref = _swig_property(_simavr.elf_firmware_t_aref_get, _simavr.elf_firmware_t_aref_set)
    ...
    if _newclass:tracename = _swig_property(_simavr.elf_firmware_t_tracename_get, _simavr.elf_firmware_t_tracename_set)
    ...
    if _newclass:traceperiod = _swig_property(_simavr.elf_firmware_t_traceperiod_get, _simavr.elf_firmware_t_traceperiod_set)
    ...
    if _newclass:tracecount = _swig_property(_simavr.elf_firmware_t_tracecount_get, _simavr.elf_firmware_t_tracecount_set)
    ...
    if _newclass:command_register_addr = _swig_property(_simavr.elf_firmware_t_command_register_addr_get, _simavr.elf_firmware_t_command_register_addr_set)
    ...
    if _newclass:console_register_addr = _swig_property(_simavr.elf_firmware_t_console_register_addr_get, _simavr.elf_firmware_t_console_register_addr_set)
    ...
    if _newclass:flashbase = _swig_property(_simavr.elf_firmware_t_flashbase_get, _simavr.elf_firmware_t_flashbase_set)
    __swig_setmethods__["flash"] = _simavr.elf_firmware_t_flash_set
    __swig_getmethods__["flash"] = _simavr.elf_firmware_t_flash_get
    if _newclass:flash = _swig_property(_simavr.elf_firmware_t_flash_get, _simavr.elf_firmware_t_flash_set)
    ...
    if _newclass:flashsize = _swig_property(_simavr.elf_firmware_t_flashsize_get, _simavr.elf_firmware_t_flashsize_set)
    ...
    if _newclass:datasize = _swig_property(_simavr.elf_firmware_t_datasize_get, _simavr.elf_firmware_t_datasize_set)
    ...
    if _newclass:bsssize = _swig_property(_simavr.elf_firmware_t_bsssize_get, _simavr.elf_firmware_t_bsssize_set)
    __swig_setmethods__["eeprom"] = _simavr.elf_firmware_t_eeprom_set
    __swig_getmethods__["eeprom"] = _simavr.elf_firmware_t_eeprom_get
    if _newclass:eeprom = _swig_property(_simavr.elf_firmware_t_eeprom_get, _simavr.elf_firmware_t_eeprom_set)
    __swig_setmethods__["eesize"] = _simavr.elf_firmware_t_eesize_set
    __swig_getmethods__["eesize"] = _simavr.elf_firmware_t_eesize_get
    if _newclass:eesize = _swig_property(_simavr.elf_firmware_t_eesize_get, _simavr.elf_firmware_t_eesize_set)
    __swig_setmethods__["codeline"] = _simavr.elf_firmware_t_codeline_set
    __swig_getmethods__["codeline"] = _simavr.elf_firmware_t_codeline_get
    if _newclass:codeline = _swig_property(_simavr.elf_firmware_t_codeline_get, _simavr.elf_firmware_t_codeline_set)
    __swig_setmethods__["codesize"] = _simavr.elf_firmware_t_codesize_set
    __swig_getmethods__["codesize"] = _simavr.elf_firmware_t_codesize_get
    if _newclass:codesize = _swig_property(_simavr.elf_firmware_t_codesize_get, _simavr.elf_firmware_t_codesize_set)
    __swig_getmethods__["trace"] = _simavr.elf_firmware_t_trace_get
    if _newclass:trace = _swig_property(_simavr.elf_firmware_t_trace_get)
    def __init__(self): 
...
class elf_firmware_t_trace(_object):
    ...
    if _newclass:mask = _swig_property(_simavr.elf_firmware_t_trace_mask_get, _simavr.elf_firmware_t_trace_mask_set)
    ...
    if _newclass:addr = _swig_property(_simavr.elf_firmware_t_trace_addr_get, _simavr.elf_firmware_t_trace_addr_set)
    ...
    if _newclass:name = _swig_property(_simavr.elf_firmware_t_trace_name_get, _simavr.elf_firmware_t_trace_name_set)
    def __init__(self): 
...
def elf_read_firmware(*args):
  return _simavr.elf_read_firmware(*args)
elf_read_firmware = _simavr.elf_read_firmware

def avr_load_firmware(*args):
  return _simavr.avr_load_firmware(*args)
...
def avr_gdb_init(*args):
  return _simavr.avr_gdb_init(*args)
avr_gdb_init = _simavr.avr_gdb_init

def avr_deinit_gdb(*args):
  return _simavr.avr_deinit_gdb(*args)
avr_deinit_gdb = _simavr.avr_deinit_gdb

def avr_gdb_processor(*args):
  return _simavr.avr_gdb_processor(*args)
avr_gdb_processor = _simavr.avr_gdb_processor

def avr_gdb_handle_watchpoints(*args):
  return _simavr.avr_gdb_handle_watchpoints(*args)
...
class avr_vcd_signal_t(_object):
    ...
    if _newclass:irq = _swig_property(_simavr.avr_vcd_signal_t_irq_get, _simavr.avr_vcd_signal_t_irq_set)
    __swig_setmethods__["alias"] = _simavr.avr_vcd_signal_t_alias_set
    __swig_getmethods__["alias"] = _simavr.avr_vcd_signal_t_alias_get
    if _newclass:alias = _swig_property(_simavr.avr_vcd_signal_t_alias_get, _simavr.avr_vcd_signal_t_alias_set)
    __swig_setmethods__["size"] = _simavr.avr_vcd_signal_t_size_set
    __swig_getmethods__["size"] = _simavr.avr_vcd_signal_t_size_get
    if _newclass:size = _swig_property(_simavr.avr_vcd_signal_t_size_get, _simavr.avr_vcd_signal_t_size_set)
    __swig_setmethods__["name"] = _simavr.avr_vcd_signal_t_name_set
    __swig_getmethods__["name"] = _simavr.avr_vcd_signal_t_name_get
    if _newclass:name = _swig_property(_simavr.avr_vcd_signal_t_name_get, _simavr.avr_vcd_signal_t_name_set)
    def __init__(self): 
...
class avr_vcd_log_t(_object):
    ...
    if _newclass:when = _swig_property(_simavr.avr_vcd_log_t_when_get, _simavr.avr_vcd_log_t_when_set)
    __swig_setmethods__["signal"] = _simavr.avr_vcd_log_t_signal_set
    __swig_getmethods__["signal"] = _simavr.avr_vcd_log_t_signal_get
    if _newclass:signal = _swig_property(_simavr.avr_vcd_log_t_signal_get, _simavr.avr_vcd_log_t_signal_set)
    __swig_setmethods__["value"] = _simavr.avr_vcd_log_t_value_set
    __swig_getmethods__["value"] = _simavr.avr_vcd_log_t_value_get
    if _newclass:value = _swig_property(_simavr.avr_vcd_log_t_value_get, _simavr.avr_vcd_log_t_value_set)
    def __init__(self): 
...
class avr_vcd_t(_object):
    ...
    if _newclass:avr = _swig_property(_simavr.avr_vcd_t_avr_get, _simavr.avr_vcd_t_avr_set)
    __swig_setmethods__["filename"] = _simavr.avr_vcd_t_filename_set
    __swig_getmethods__["filename"] = _simavr.avr_vcd_t_filename_get
    if _newclass:filename = _swig_property(_simavr.avr_vcd_t_filename_get, _simavr.avr_vcd_t_filename_set)
    __swig_setmethods__["output"] = _simavr.avr_vcd_t_output_set
    __swig_getmethods__["output"] = _simavr.avr_vcd_t_output_get
    if _newclass:output = _swig_property(_simavr.avr_vcd_t_output_get, _simavr.avr_vcd_t_output_set)
    ...
    if _newclass:signal_count = _swig_property(_simavr.avr_vcd_t_signal_count_get, _simavr.avr_vcd_t_signal_count_set)
    __swig_setmethods__["signal"] = _simavr.avr_vcd_t_signal_set
    __swig_getmethods__["signal"] = _simavr.avr_vcd_t_signal_get
    if _newclass:signal = _swig_property(_simavr.avr_vcd_t_signal_get, _simavr.avr_vcd_t_signal_set)
    __swig_setmethods__["period"] = _simavr.avr_vcd_t_period_set
    __swig_getmethods__["period"] = _simavr.avr_vcd_t_period_get
    if _newclass:period = _swig_property(_simavr.avr_vcd_t_period_get, _simavr.avr_vcd_t_period_set)
    __swig_setmethods__["start"] = _simavr.avr_vcd_t_start_set
    __swig_getmethods__["start"] = _simavr.avr_vcd_t_start_get
    if _newclass:start = _swig_property(_simavr.avr_vcd_t_start_get, _simavr.avr_vcd_t_start_set)
    __swig_setmethods__["logsize"] = _simavr.avr_vcd_t_logsize_set
    __swig_getmethods__["logsize"] = _simavr.avr_vcd_t_logsize_get
    if _newclass:logsize = _swig_property(_simavr.avr_vcd_t_logsize_get, _simavr.avr_vcd_t_logsize_set)
    __swig_setmethods__["logindex"] = _simavr.avr_vcd_t_logindex_set
    __swig_getmethods__["logindex"] = _simavr.avr_vcd_t_logindex_get
    if _newclass:logindex = _swig_property(_simavr.avr_vcd_t_logindex_get, _simavr.avr_vcd_t_logindex_set)
    __swig_setmethods__["log"] = _simavr.avr_vcd_t_log_set
    __swig_getmethods__["log"] = _simavr.avr_vcd_t_log_get
    if _newclass:log = _swig_property(_simavr.avr_vcd_t_log_get, _simavr.avr_vcd_t_log_set)
    def __init__(self): 
...
def avr_vcd_init(*args):
  return _simavr.avr_vcd_init(*args)
avr_vcd_init = _simavr.avr_vcd_init

def avr_vcd_close(*args):
  return _simavr.avr_vcd_close(*args)
avr_vcd_close = _simavr.avr_vcd_close

def avr_vcd_add_signal(*args):
  return _simavr.avr_vcd_add_signal(*args)
avr_vcd_add_signal = _simavr.avr_vcd_add_signal

def avr_vcd_start(*args):
  return _simavr.avr_vcd_start(*args)
avr_vcd_start = _simavr.avr_vcd_start

def avr_vcd_stop(*args):
  return _simavr.avr_vcd_stop(*args)
...
def mem_logger_print(*args):
  return _simavr.mem_logger_print(*args)
mem_logger_print = _simavr.mem_logger_print
