...
def setup_product():
    ...
    import xhostplus.gallery
    zcml.load_config('configure.zcml', xhostplus.gallery)
    ...
    ztc.installPackage('xhostplus.gallery')
...
setup_product()
ptc.setupPloneSite(products=['xhostplus.gallery'])
