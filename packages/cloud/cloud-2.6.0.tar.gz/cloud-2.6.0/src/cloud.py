...
class Cloud(object):
    ...
    def call(self, func, *args, **kwargs):
    	...
    	* _profile:
    	    ...
    	    valuable for debugging, and finding bottlenecks, but may slow down your job.
        * _restartable:
    ...
    def info(self, jids, info_requested=None):
        ...
        * memory: Variety of information about memory usage, swap usage, and allocation failures
