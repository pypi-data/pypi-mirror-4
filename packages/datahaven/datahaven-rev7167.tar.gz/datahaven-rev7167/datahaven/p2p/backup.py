...
#                packetId = packetid.MakePacketID(newblock.BackupID, newblock.BlockNumber, supplierNum, DataOrParity)
...
#        self.sendingDelay = misc.LoopAttenuation(
#             self.sendingDelay, 
#             len(self.outstandingPackets) > 0, 
...
#            return
#
#        # take ID, block number, supplier number and type
#        backupID, blockNum, supplierNum, dataORparity = packet.PacketID.split('-')
#        blockNum = int(blockNum)
#        supplierNum = int(supplierNum)
#        DorP = dataORparity[0] # "D" or "P"
#        if backupID != self.backupID:
#            dhnio.Dprint(4, 'backup.packetAcked WARNING backup ID did not match')
#        
...
#        DorP = dataORparity[0] # "D" or "P"
#        if backupID != self.backupID:
#            dhnio.Dprint(4, 'backup.packetFailed WARNING backup ID did not match')
#
...
#        backups.RemoteFileReport(backupID, blockNum, supplierNum, dataORparity, Result)
