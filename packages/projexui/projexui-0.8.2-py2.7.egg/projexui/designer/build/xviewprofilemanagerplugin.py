...
from projexui.widgets.xviewwidget import XViewProfileManager as WidgetClass

class XViewProfileManagerPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XViewProfileManagerPlugin, self).__init__( parent )
    ...
    def domXml( self ):
        ...
        return '<widget class="XViewProfileManager" name="XViewProfileManager"/>'
