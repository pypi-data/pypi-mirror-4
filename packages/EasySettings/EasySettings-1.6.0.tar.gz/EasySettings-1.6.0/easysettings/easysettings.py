...
class easysettings():
    ...
    def save(self, sfile = None):
        ...
        try:
            ...
            # failed to open file
            raise esSaveError("failed to open file for write!: " + \
                              sfile + '\n\nError:\n' + str(ex))
            return False
    ...
    def has_value(self, value):
        ...
        if isinstance(value, str):
            return (value in self.settings.itervalues())
        else:
            # try non-string types
            for val in self.settings.itervalues():
                try:
...
def test_run(stestconfigfile = None):
    ...
    print "         set('o', 123456L): " + str(es.set('o', 123456L))
    ...
    print "    list_settings(123456L): " + str(es.list_settings(123456L))
    print "      list_values(123456L): " + str(es.list_values(123456L))
