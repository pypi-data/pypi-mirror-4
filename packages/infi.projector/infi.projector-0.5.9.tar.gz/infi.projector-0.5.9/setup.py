...
SETUP_INFO = dict(
    ...
    install_requires = ['zc.buildout>=1.6.3', 'gitflow>=0.5.0', 'git-py>=1.0.0', 'distribute>=0.6.35', 'gitdb>=0.5.4', 'infi.recipe.template.version>=0.4.12', 'docopt>=0.6.1', 'async>=0.6.1', 'infi.pyutils>=0.0.30', 'infi.execute>=0.0.8', 'infi.exceptools>=0.2.2', 'smmap>=0.8.2', 'infi.traceback>=0.3.3'],
