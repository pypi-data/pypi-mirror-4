...
void __Image()
{
    ...
    class_< Magick::Image >("Image", init<  >())
        ...
        .def("getConstIndexes",)
#endif
        .def("getPixels", (Magick::PixelPacket (Magick::Image::*)(int, int, int, int) const)&Magick::Image::getPixels)
        .def("setPixels", (void (Magick::Image::*)() const)&Magick::Image::setPixels)
