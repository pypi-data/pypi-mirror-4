...
if __name__ == "__main__":
    ...
    import pyspeckit.spectrum.models.GaussianModel
    from pyspeckit.spectrum.models.GaussianModel import GaussianModel

    # not implemented yet, but this is how it should work
    MyModel = CompositeModel()
    MyModel += GaussianModel(parameters=[1,0,0])
    MyModel += GaussianModel(parameters=[1,0,0])
    MyModel += AdditiveModelComponent(lambda x,m,b: m*x+b,'line1',params=[1,0])
