...
Releasing a new version of `ucg` involves the following steps:
...
In the following example we are releasing version 0.1 of `ucg`. The
...
.. sourcecode:: bash
  ...
  Releasing ucg 0.1
  Tagging ucg 0.1
  To git@github.com:niteoweb/ucg.git
  * [new tag]         0.1 -> 0.1
  running egg_info
  running sdist
