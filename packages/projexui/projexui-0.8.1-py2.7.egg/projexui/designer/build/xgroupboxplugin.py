...
from projexui.widgets.xgroupbox import XGroupBox as WidgetClass

class XGroupBoxPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XGroupBoxPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xgroupbox'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XGroupBox" name="XGroupBox"/>'
