...
set CERT = " --cert=/Users/jjk/.ssl/cadcproxy.pem"
...
$MOUNTCMD $CERT --vospace=$BASE --mountpoint=$MOUNTPOINT --cache_dir=/tmp/vos_cache --log=/tmp/mountvofs.log -d || echo " [FAIL]" && exit -1
sleep 3
ls $MOUNTPOINT >& /dev/null || echo [FAIL] && exit -1
echo " [OK]"

echo -n "make new directory $MOUNTPOINT/$TIMESTAMP"
