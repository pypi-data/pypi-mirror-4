    ...
    def join(self, jids, timeout = None, ignore_errors = False):
        ...
        while True:
            ...
            if old_queued != fse.num_queued:
                ...
                raise CloudTimeoutError('cloud.join detected possible live-lock due to recursive jobs. See http://docs.picloud.com/cloud_pitfalls.html#cloud-call-recursion', neededJids)
