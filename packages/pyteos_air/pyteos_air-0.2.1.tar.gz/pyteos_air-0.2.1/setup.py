...
setup(name='pyteos_air',
    ...
    package_dir = {'pyteos_air': ''},
        ...
        author_email = "frederic.laliberte@utoronto.ca",
        description = "This package provides python bindings to the atmospheric component of TEOS-10. Includes also expanded metorological quantities like the equivalent potential temperature.",
        license = "BSD",
        keywords = "thermodynamics atmosphere climate",
        url = "www.teos-10.org",   # project home page, if any
        classifiers=[
