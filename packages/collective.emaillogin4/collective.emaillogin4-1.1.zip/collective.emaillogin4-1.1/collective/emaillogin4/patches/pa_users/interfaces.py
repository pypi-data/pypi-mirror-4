...
import plone.app.users.browser.interfaces
...
# Patch it.
plone.app.users.browser.interfaces.IUserIdGenerator = IUserIdGenerator
plone.app.users.browser.interfaces.ILoginNameGenerator = ILoginNameGenerator
