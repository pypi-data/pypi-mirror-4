...
from zweb.lib.mako import util
...
<%!
    from zweb.lib.mako.exceptions import RichTraceback
%>\
<%
...
try:
    from zweb.lib.mako.ext.pygmentplugin import syntax_highlight,\
            pygments_html_formatter
except ImportError:
    from zweb.lib.mako.filters import html_escape
...
def html_error_template():
    ...
    return mako.template.Template(r"""
<%!
    from zweb.lib.mako.exceptions import RichTraceback, syntax_highlight,\
            pygments_html_formatter
%>
