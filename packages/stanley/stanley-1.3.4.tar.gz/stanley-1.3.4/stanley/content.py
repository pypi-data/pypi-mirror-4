...
class Post(Content):
    ...
    def __init__(self, src_dir='', src_file='', data={}, content=''):
        """
        The src_dir argument is the path to the filename without the original
        source. For example /my/site/content/blog/2012-12-12-a-file.md would
        be blog, and /my/site/content/blog/thing/2012-12-12-a-file.md would be
        blog/thing
        """
        ...
        self.src_dir = self.category = src_dir
