...
from projexui.widgets.xrolloutwidget import XRolloutWidget as WidgetClass

class XRolloutWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XRolloutWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xrolloutwidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XRolloutWidget" name="XRolloutWidget"/>'
