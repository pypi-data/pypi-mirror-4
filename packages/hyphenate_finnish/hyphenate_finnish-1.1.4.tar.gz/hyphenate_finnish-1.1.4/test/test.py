	...
	if tavutus == oikea_vastaus:
		...
		for i, c in enumerate(tavutus):
			if c != oikea_vastaus[i]:
				print(i, c, oikea_vastaus[i:i+20])
				break
...
teksti_c2='''
<p class="signature">
Ta-va-taan kurssilla!<br/>
<span style="font-family: 'Give You Glory', cursive; font-size: 1.5em;">Pyry Kontio</span><br/>
kurs-sin opettaja<br/>
</p>
'''
teksti_c3='''
...
'''
tavutus1 = hyphenate(teksti1, skip_html=True, margin=1, hyphen='-')
testaa(tavutus1, teksti_c1, "Testi 1")
tavutus2 = hyphenate(teksti2, skip_html=True, margin=1, hyphen='-')
testaa(tavutus2, teksti_c2, "Testi 2")
tavutus3 = hyphenate(teksti3, skip_html=True, margin=1, hyphen='-')
testaa(tavutus3, teksti_c3, "Testi 3")
testaa(hyphenate('Murr'), "Murr", "Testi 4")
tavutus2 = hyphenate(teksti2, skip_html=False, margin=1, hyphen='-')
testaa(tavutus2, teksti_c5, "Testi 5")