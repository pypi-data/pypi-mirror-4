...
def create_database_from_tree(session,file_expt,paths_dict,top_name,find_function,tree_desc):
    if isinstance(paths_dict,dict):
        for value in paths_dict.keys():
            if value[0] != '_':
                ...
                create_database_from_tree(session,file_expt_copy,paths_dict[value],value,find_function,tree_desc_copy)
