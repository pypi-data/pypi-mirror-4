...
class Ui_SWMM5EA(object):
    def setupUi(self, SWMM5EA):
        ...
        SWMM5EA.resize(941, 713)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(SWMM5EA.sizePolicy().hasHeightForWidth())
        SWMM5EA.setSizePolicy(sizePolicy)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 941, 18))
        ...
        sizePolicy.setHeightForWidth(self.curve_window.sizePolicy().hasHeightForWidth())
        self.curve_window.setSizePolicy(sizePolicy)
        self.curve_window.setMinimumSize(QtCore.QSize(300, 400))
        ...
        self.action_Zoom_Extent = QtGui.QAction(SWMM5EA)
        self.action_Zoom_Extent.setCheckable(True)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/res/res/zoom_fit_best.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Zoom_Extent.setIcon(icon14)
        self.action_Zoom_Extent.setObjectName(_fromUtf8("action_Zoom_Extent"))
        ...
        self.menuView.addAction(self.action_Zoom_Extent)
        ...
        self.Main_toolbar.addAction(self.action_Zoom_Extent)
        self.Main_toolbar.addSeparator()
    ...
    def retranslateUi(self, SWMM5EA):
        ...
        self.menuView.setTitle(QtGui.QApplication.translate("SWMM5EA", "View", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionInitialize_model.setText(QtGui.QApplication.translate("SWMM5EA", "Initialize the optimization", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_Zoom_Extent.setText(QtGui.QApplication.translate("SWMM5EA", "&Zoom Extent", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Zoom_Extent.setToolTip(QtGui.QApplication.translate("SWMM5EA", "Zoom the graph to the data extent", None, QtGui.QApplication.UnicodeUTF8))
