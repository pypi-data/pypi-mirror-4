...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('collection_product', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.featured'
        db.delete_column('collection_product', 'featured')
