...
from projexui.widgets.xlineedit import XLineEdit as Base

class XLineEditPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XLineEditPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xlineedit'
    
    def domXml( self ):
        default = '<widget class="XLineEdit" name="XLineEdit"/>'
