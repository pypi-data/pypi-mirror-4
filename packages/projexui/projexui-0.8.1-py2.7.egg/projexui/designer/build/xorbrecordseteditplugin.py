...
from projexui.widgets.xorbrecordsetedit import XOrbRecordSetEdit as WidgetClass

class XOrbRecordSetEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbRecordSetEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbrecordsetedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbRecordSetEdit" name="XOrbRecordSetEdit"/>'
