	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				extensions: ['ext-markers.js','ext-connector.js', 'ext-eyedropper.js', 'ext-shapes.js', 'ext-imagelib.js','ext-grid.js', 'ext-server_moinsave.js'],
				initTool: 'select',
				wireframe: false,
				colorPickerCSS: null,
				gridSnapping: false,
...
// 			});
		...
		//	var revnums = "svg-editor.js ($Rev: 2090 $) ";
