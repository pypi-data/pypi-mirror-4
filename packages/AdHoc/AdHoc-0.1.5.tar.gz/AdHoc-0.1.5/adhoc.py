    ...
    **User API**
    ...
    def std_template_param(cls, file_=None, source=None,     # |:clm:|
        ...
        if tag is None:
            is_re=True
            if all_:
                tag = cls.section_tag('adhoc_(template(_v)?|import|unpack)')
            else:
...
def adhoc_check_module_setup():                            # ||:fnc:||
    ...
    #   :DBG:   strclean                 : ]<function strclean>[
    ...
    if adhoc_op:
        ...
        # template
            ...
            # |:special:|
                ...
                README = get_readme(file_, source, as_template=True, transform=False)
                AdHoc.write_source('-', AdHoc.get_named_template('README.txt', file_, README))
            # |:special:|
            else:
...
if False:
    ...
    # @:adhoc_include:@ use_case_000_templates_.py
