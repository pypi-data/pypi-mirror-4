...
class VTLSClientBase(object):
    ...
    *tls_req_cert* should be one of :attr:`CERT_NONE`\ ,
    ...
    def __init__(self, tls_wrapped, tls_server, tls_keyfile, tls_certfile,
        ...
        if tls_keyfile and not isinstance(tls_keyfile, (bytes, str)):
        ...
        if tls_certfile and not isinstance(tls_certfile, (bytes, str)):
        ...
        if tls_cafile and not isinstance(tls_cafile, (bytes, str)):
