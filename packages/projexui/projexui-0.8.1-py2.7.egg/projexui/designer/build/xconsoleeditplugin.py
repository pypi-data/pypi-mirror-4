...
from projexui.widgets.xconsoleedit import XConsoleEdit as WidgetClass

class XConsoleEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XConsoleEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xconsoleedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XConsoleEdit" name="XConsoleEdit"/>'
