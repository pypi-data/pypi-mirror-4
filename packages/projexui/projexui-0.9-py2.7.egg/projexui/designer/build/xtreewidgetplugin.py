...
from projexui.widgets.xtreewidget import XTreeWidget as Base

class XTreeWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XTreeWidgetPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtreewidget'
    
    def domXml( self ):
        default = '<widget class="XTreeWidget" name="XTreeWidget"/>'
