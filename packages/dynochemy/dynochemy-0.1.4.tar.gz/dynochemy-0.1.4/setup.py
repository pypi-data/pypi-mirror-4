...
setup(
    ...
    package_data={'dynochemy': ['LICENSE', 'NOTICE', 'README', 'AUTHORS.txt', 'README.md']},
    license=get_init_val('license'),
    install_requires=['asyncdynamo>=0.2.6', 'boto>=2.6.0', 'sqlalchemy'],
    requires=['asyncdynamo', 'boto', 'sqlalchemy'],
    packages=PACKAGES
)
