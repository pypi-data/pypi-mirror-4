                                ...
                                for file in files:
                                        ...
                                        if settings.has_option("scm", "auto_version"):
                                                ...
                                                if fullpath.lower().endswith((".master",".inc",".aspx",".ascx",".php",".htm",".html")):
                                                        ...
                                                        filetext = filetext.replace(".php\"", ".php?" + hash + "\"")
                                                        filetext = filetext.replace(".htm\"", ".htm?" + hash + "\"")
                                                        filetext = filetext.replace(".html\"", ".html?" + hash + "\"")
                                                        filetext = filetext.replace(".inc\"", ".inc?" + hash + "\"")
                                                        filetext = filetext.replace(".jpg\"", ".jpg?" + hash + "\"")
                                                        filetext = filetext.replace(".jpeg\"", ".jpeg?" + hash + "\"")
                                                        filetext = filetext.replace(".gif\"", ".gif?" + hash + "\"")
                                                        filetext = filetext.replace(".png\"", ".png?" + hash + "\"")
                                                        f = open(fullpath, 'w')
                                                        f.write(filetext)
                                                        f.close()
