...
var reqAjaximage = require.config({
  baseUrl: __admin_media_prefix__.replace('/admin/', '/') + 'ajaximage/js/'
})

var loadAjaximage = []
if( ! jQuery.widget) loadAjaximage.push('jquery.ui.widget')
if( ! jQuery().fileupload) loadAjaximage.push('jquery.fileupload')

reqAjaximage(loadAjaximage, function(){
