...
def setup_product():
    ...
    import Products.pressKit
    zcml.load_config('configure.zcml', Products.pressKit)
    ...
    ztc.installPackage('Products.pressKit')
...
setup_product()
ptc.setupPloneSite(products=['Products.pressKit'])
