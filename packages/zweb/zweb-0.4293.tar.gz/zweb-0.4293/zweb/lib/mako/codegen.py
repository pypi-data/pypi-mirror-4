...
import time
import re
from zweb.lib.mako.pygen import PythonPrinter
from zweb.lib.mako import util, ast, parsetree, filters, exceptions
...
class _GenerateRenderMethod(object):
    ...
    def write_toplevel(self):
        ...
        self.printer.writeline("from zweb.lib.mako import runtime, filters, cache")
