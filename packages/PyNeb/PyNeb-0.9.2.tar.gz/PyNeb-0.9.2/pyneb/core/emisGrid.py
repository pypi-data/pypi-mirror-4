...
class EmisGrid(object):
    ...
    def __init__(self, elem=None, spec=None, n_tem=100, n_den=100, tem_min=5000., tem_max=20000.,
        ...
        Parameters:
            ...
            - AtomObs:    an atom object. In this case, no need for elem and spec.
        """
        self.log_ = pn.log_
...
#        self.emis_grid = self.atom.getEmissivity(self.tem, self.den)
    ...
    def plotImage(self, to_eval=None, lev_i1=None, lev_j1=None, lev_i2=None, lev_j2=None, 
        ...
        Parameters:
            - to_eval: algrebric expression of the line combination to draw. May combine L(lambda) and I(i,j).
            - lev_i1, lev_i2,lev_j1,lev_j2: levels of the a lines in case of simple line ratio plot.
            - wave1, wave2:    wavelengths of the 2 lines in case of simple line ratio plot.
            - **kwargs:     any other parameter will be send to contourf and pcolor
...
def getEmisGridDict(elem_list=None, spec_list=None, atom_list=None, restore=True, pypic_path=None,
    ...
    Parameters:
        ...
        - restore:    Boolean, if True (default), the program will search for a previously computed grid.
                        If not found, will compute the EMisGrid (unless computeIfAbsent is set to False)
        - pypic_path:    Directory where to look for the pypic emissivity files. 
                The default value is None and leads to be defined by pn.config.pypic_path, at the start of PyNeb: it is $HOME/.pypics if
                the ENVIRONMENT variable HOME is accessible. Otherwise /tmp/pypics is used.
        - n_tem, n_den:    number of points in the Te and Ne samples resp. 
        - tem_min, tem_max, den_min, den_max:    limits for Te and Ne
        - save:    Boolean, if True (default), the emissivity grid will be saved. Has no effect if the EmisGrid
