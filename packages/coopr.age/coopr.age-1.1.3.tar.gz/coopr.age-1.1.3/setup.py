...
"""
Script to generate the installer for coopr.age.
"""
...
setup(name='coopr.age',
      version='1.1.3',
      maintainer='Carl Laird',
      maintainer_email='carl.laird@tamu.edu',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.age',
      license = 'BSD',
      platforms = ["any"],
      description = 'A QT interface for Coopr that supports the formulation and analysis of Pyomo models',
      ...
      entry_points="""
        [console_scripts]
        CooprAge = coopr.age.CooprAge:run
      """
      )
