...
##############################################################################
"""
$Id: client.py 3065 2012-09-02 12:13:31Z roger.ineichen $
"""
...
logger = logging.getLogger('m01.session')
...
class ClientIdFactory(object):
    ...
    zope.interface.implements(interfaces.IClientIdFactory)

    lifetime = FieldProperty(
        interfaces.IClientIdFactory['lifetime'])
    secure = FieldProperty(interfaces.IClientIdFactory['secure'])
    postOnly = FieldProperty(interfaces.IClientIdFactory['postOnly'])
    domain = FieldProperty(interfaces.IClientIdFactory['domain'])
