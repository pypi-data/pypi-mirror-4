...
class MegamanicEditable:
    ...
    security.declarePublic('get_add_skip_fields')
    def get_add_skip_fields(self):
        #"Returns fields to skip when adding template objects"
        return getattr(self, 'getAddSkipFields', lambda: ())()

    security.declarePublic('get_required_fields')
    def get_required_fields(self):
        #"Returns fields to skip when adding template objects"
        return getattr(self, 'getRequiredFields', lambda: ())()

    security.declarePublic('get_table_listing_fields')
    def get_table_listing_fields(self):
        #"Returns fields to skip when adding template objects"
        return getattr(self, 'getTableListingFields', lambda: ())()
...
class MegamanicEditableTemplateObject(MegamanicEditable):
    ...
    def manage_afterAdd(self, item, container):
        ...
        self.setTableListingFields((self.getId() + '_title',
                                    self.getId() + '_description'))
        try:
            try:
