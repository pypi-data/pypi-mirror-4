...
from commodity.log import CapitalLoggingFormatter, CallerData
...
class StatusFilter(logging.Filter):
    ...
    def filter(self, record):
        ...
        record.msg = msg.safe_substitute(values) + term().normal
        return True
