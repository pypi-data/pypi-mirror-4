...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.cost_purchase'
        db.add_column('collection_product', 'cost_purchase',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product.cost_work'
        db.add_column('collection_product', 'cost_work',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Product.cost_purchase'
        db.delete_column('collection_product', 'cost_purchase')

        # Deleting field 'Product.cost_work'
        db.delete_column('collection_product', 'cost_work')
    ...
    models = {
        ...
        'collection.product': {
            ...
            'cost_purchase': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'cost_work': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'price_eur': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'price_gbp': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
