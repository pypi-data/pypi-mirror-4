...
<body>""")
	...
	<div data-role="content">""")
		...
		self.pylToHtmlResult+=str("""
			<h2>""")
		self.pylToHtmlResult+=str("""파일""")
		self.pylToHtmlResult+=str(""" 업로드""")
		self.pylToHtmlResult+=str(""" Test""")
		self.pylToHtmlResult+=str("""</h2>""")
		self.pylToHtmlResult+=str("""
			<p>""")
		self.pylToHtmlResult+=str("""웹사이트의""")
		self.pylToHtmlResult+=str(""" 이미지을""")
		self.pylToHtmlResult+=str(""" 업로드하여""")
		self.pylToHtmlResult+=str(""" 아래의""")
		self.pylToHtmlResult+=str(""" 이미지를""")
		self.pylToHtmlResult+=str(""" 변경한다.""")
		self.pylToHtmlResult+=str("""</p>""")
		self.pylToHtmlResult+=str("""
			<div>""")
		self.pylToHtmlResult+=str("""
				<form id="fileForm" data-ajax="false" class="ui-body ui-body-a ui-corner-all" method="post" enctype="multipart/form-data" action="/faviconUpload">""")
		self.pylToHtmlResult+=str("""
