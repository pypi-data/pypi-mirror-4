...
import struct
from mud.tools.hashlib import sha1
...
try: from mud.player import ACMDLN, Option
except ImportError: pass
else:
    ...
    def doProduceOOB(peer, command):
        if peer is not None:
            ...
            if name:
                ...
                from mud.player.notebook import Notebook
...
try: from mud.runtime import Component
except ImportError: pass
else:
    class OOBNework(Component):
