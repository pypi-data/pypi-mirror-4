...
"""
Script to generate the installer for coopr.pysos.
"""
...
setup(name='coopr.pysos',
      version='2.0.8',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.pysos',
      license = 'BSD',
      platforms = ["any"],
      description = 'Coopr utilities for composing heterogeous models',
      ...
      entry_points = """
        [console_scripts]
        pysos=coopr.pysos.pysos_cmd:main
      """
      )
