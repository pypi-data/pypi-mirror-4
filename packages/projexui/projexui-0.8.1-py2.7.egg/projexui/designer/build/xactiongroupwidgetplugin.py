...
from projexui.widgets.xactiongroupwidget import XActionGroupWidget as WidgetClass

class XActionGroupWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XActionGroupWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xactiongroupwidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XActionGroupWidget" name="XActionGroupWidget"/>'
