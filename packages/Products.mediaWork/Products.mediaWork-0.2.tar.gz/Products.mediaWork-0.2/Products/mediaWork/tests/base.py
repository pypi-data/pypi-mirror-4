...
def setup_product():
    ...
    import Products.mediaWork
    zcml.load_config('configure.zcml', Products.mediaWork)
    ...
    ztc.installPackage('Products.mediaWork')
...
setup_product()
ptc.setupPloneSite(products=['Products.mediaWork'])
