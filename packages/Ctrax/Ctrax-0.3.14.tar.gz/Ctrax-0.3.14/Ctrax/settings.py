...
if False and pyglet_version[:3] < '1.2':
    from motmot.wxglvideo.simple_overlay import DynamicImageCanvas
    USING_WXGLVIDEO = True
else:
    from motmot.wxvideo.wxvideo import DynamicImageCanvas
    USING_WXGLVIDEO = False
...
class AppWithSettings( wx.App ):
    ...
    def reset_img_wind( self ):
        ...
        self.using_wxglvideo = USING_WXGLVIDEO
        if not USING_WXGLVIDEO:
