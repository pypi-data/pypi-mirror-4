...
from collective.portlet.colorcollection import exampleportlet

from collective.portlet.colorcollection.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='collective.portlet.colorcollection.ExamplePortlet')
        self.assertEquals(portlet.addview,
                          'collective.portlet.colorcollection.ExamplePortlet')
