...
from eggplant.validators.iterator import len_validator
...
class ModelCollectionView(ModelViewBase):
    ...
    @validate_keys(
        (('page_size', 'limit'),
          (is_positive_integer, len_validator(1, '>='),
           len_validator(getattr(settings, MAX_PAGINATION_SIZE, eggplant_defaults.EGGPLANT_MAX_PAGINATION_SIZE), '<=')
          )
         ),
