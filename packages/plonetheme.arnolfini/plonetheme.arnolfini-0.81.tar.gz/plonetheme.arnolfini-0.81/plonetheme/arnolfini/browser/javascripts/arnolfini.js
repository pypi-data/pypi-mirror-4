...
resizer.onResize = function ()
{
	...
	else
	{
		...
		Arnolfini.resizeImg("#FrontPageManagerRight .portletWrapper .portletCollection", "mini");
...
Arnolfini.frontPageColors = function ()
{
	...
	for (i in Arnolfini.colorMapping)
	{
		...
		$("body.template-front_page_view .tag_" + tag['tag']).each(function () {
			var taken = false;
...
Arnolfini.trackEcommerce = function ()
{
	
}

Arnolfini.sendPaypalTrack = function (title, price)
{
	_gaq.push(['_addTrans',
	   encodeURIComponent(title),           // transaction ID - required
...
$(document).ready(function() {
	...
	if( navigator.userAgent.match(/iPad/i) == null ){  
		...
		viewport.setAttribute('content', "width=777, initial-scale=0.3");  
	}
	
	Arnolfini.trackEcommerce();
});
