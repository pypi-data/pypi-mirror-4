__all__ = ["classifier", "regression", "recommender", "stat", "graph", "anomaly"]
 ...
 from jubatus.graph.client import graph as Graph
 from jubatus.anomaly.client import anomaly as Anomaly
