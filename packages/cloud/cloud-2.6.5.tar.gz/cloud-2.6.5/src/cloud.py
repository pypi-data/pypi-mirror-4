...
class Cloud(object):
    ...
    def call(self, func, *args, **kwargs):
        ...
        * _restartable:
            ...
            that modify external state (e.g. it adds rows to a database) should set this
        ...
        * _type:
            ...
            'f2'                    
                5.5 compute units, 3.75 GB ram, high I/O                                    
            'm1'                    
    ...
    def join(self, jids, timeout = None, ignore_errors = False):
        ...
        while True:
            ...
            if self.running_on_cloud() or self.adapter.isSlave:
            ...
            if old_queued != fse.num_queued:
                ...
                raise CloudTimeoutError('cloud.join detected possible live-lock due to recursive jobs. See http://docs.picloud.com/client_pitfall.html#cloud-call-recursion', neededJids)
    ...
    def info(self, jids, info_requested=None):
        ...
        * profile: The profile of the function that ran (if _profile was True)
    ...
    def map(self, func, *args, **kwargs):
        ...
        * _profile:
                ...
                WARNING: Profiling a map job is considered bad practice,  as profiling can slow your 
                job significantly; 10x slowdowns are known to occur
        * _restartable:
