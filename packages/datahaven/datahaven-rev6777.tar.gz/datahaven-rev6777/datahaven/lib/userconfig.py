...
InfosDict = {
    ...
    'general-local-backups-enable': "Keep a copy of your backups on local HDD?",
    ...
    'transport-udp-port':           'Enter the UDP port number for the transport_tcp, it will be used to connect with your machine. Enter 0 to use multicast.',
