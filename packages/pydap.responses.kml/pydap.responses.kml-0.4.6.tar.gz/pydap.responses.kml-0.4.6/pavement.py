...
options(
    setup=Bunch(
        name='pydap.responses.kml',
        version='.'.join(str(d) for d in __version__),
        description='KML response for Pydap',
        long_description='''
...
Google Earth.
        ''',
        keywords='kml opendap dods dap data science climate oceanography meteorology',
        ...
        url='http://pydap.org/responses.html#kml',
        license='MIT',
        ...
        entry_points="""
            [pydap.response]
            kml = pydap.responses.kml:KMLResponse
        """,
    ),
    minilib=Bunch(
