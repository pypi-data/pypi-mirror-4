...
library = Library('kotti_theme_spruce', 'static')
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_spruce.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_spruce.edit_needed'