...
if sys.version_info[0] == 2 and sys.version_info[1] >= 7:
    print "importlib is included in Python 2.7 and newer for 2.x, skipping"
elif sys.version_info[0] == 3 and sys.version_info[1] >= 1:
    print "importlib is included in Python 3.1 and newer for 3.x, skipping"
...
setup(
        ...
        author_email='amckay@mozilla.com',
