...
class FileDownloader(object):
    ...
    def add_progress_hook(self, ph):
        ...
        * status: One of "error", "downloading", and "finished"
        ...
        * _data_block: Currently downloaded block (which got downloaded_bytes to the current value).
                       Should not be used outside of youtube-dl.

        Hooks are guaranteed to be called at least once with status "finished" or "error".
        """
