...
VERSION = (0,
           ...
           2,   # error handling; add_verbosity_options(q_args)
           'rev-%s' % '$Rev: 901 $'[6:-2],
           )
...
def add_version_option(pog, *args, **kwargs):
    ...
    to the non-default --version option is the addition '-V' option string
...
def add_verbosity_options(pug,
    ...
    try:
        ...
        pass
    pug.add_option('--quiet',
                   dest=dest,
                   action='store_const',
                   const=0,
                   help=quiet_help)

def add_glob_options(pug,
                     dest=None,
                     default=None):
    """
