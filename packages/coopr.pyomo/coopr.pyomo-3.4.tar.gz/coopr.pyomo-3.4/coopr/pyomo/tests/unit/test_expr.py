...
from coopr.pyomo.base.expr import _SumExpression, _ProductExpression, \
     ...
     _InequalityExpression, _IdentityExpression, UNREFERENCED_EXPR_COUNT, \
     UNREFERENCED_RELATIONAL_EXPR_COUNT, CHAINED_EXPR_COUNT, \
...
class PrettyPrinter(pyutilib.th.TestCase):
    def test_sum(self):
        ...
        self.assertEqual("sum( 5 , a , a ) \n", buf.getvalue())

        expr += 5
        buf = StringIO()
        expr.pprint(ostream=buf)
        self.assertEqual("sum( 10 , a , a ) \n", buf.getvalue())
    ...
    def test_prod(self):
        ...
        buf = StringIO()
        expr.pprint(ostream=buf)
        self.assertEqual("prod( num=( 5 , a , a ) ) \n", buf.getvalue())
    ...
    def test_inequality(self):
        ...
        buf = StringIO()
        expr.pprint(ostream=buf)
        self.assertEqual( "5.0  <=  sum( 5 , a ) \n", buf.getvalue() )

        expr = expr < 10
        buf = StringIO()
        expr.pprint(ostream=buf)
        self.assertEqual( "5.0  <=  sum( 5 , a )  <  10.0 \n", buf.getvalue() )
    ...
    def test_relational_UNREFERENCED_EXPR_COUNT(self):
        try:
            ...
            try:
                ...
                pass
            self.assertEqual( TrapRefCount.inst.refCount, [0,1,1,CHAINED_EXPR_COUNT] )
