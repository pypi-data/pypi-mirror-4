...
from projexui.widgets.xrichtextedit import XRichTextEdit as WidgetClass

class XRichTextEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XRichTextEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xrichtextedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XRichTextEdit" name="XRichTextEdit"/>'
