...
def setup_product():
    ...
    import collective.taxonomysupport
    zcml.load_config('configure.zcml', collective.taxonomysupport)
    ...
    ztc.installPackage('collective.taxonomysupport')
...
setup_product()
ptc.setupPloneSite(products=['collective.taxonomysupport'])
