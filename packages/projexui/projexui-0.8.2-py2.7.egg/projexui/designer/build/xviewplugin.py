...
from projexui.widgets.xviewwidget import XView as WidgetClass

class XViewPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XViewPlugin, self).__init__( parent )
    ...
    def domXml( self ):
        ...
        return '<widget class="XView" name="XView"/>'
