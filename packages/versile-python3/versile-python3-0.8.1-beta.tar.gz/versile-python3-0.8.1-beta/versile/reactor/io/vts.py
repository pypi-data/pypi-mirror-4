# Copyright (C) 2011-2012 Versile AS
# 
...
class VSecureClient(VSecure):
    ...
    def _send_pubkey(self, data):
        try:
            ...
            if not (isinstance(hmac_name, str)
                    and isinstance(cipher_name, str)
                    and isinstance(cipher_mode, str)
                    and isinstance(hash_name, str)
            ...
            if not isinstance(s_pub_name, str):
    ...
    def _ack_hello(self, data):        
        try:
            ...
            for cipher in ciphers:
                ...
                if not (isinstance(c_name, str) and
    ...
    def _get_pubkey(self, data):
        try:
            ...
            if c_keydata is not None:
                ...
                if not isinstance(c_pub_name, str):
                    raise VIOError('Invalid public key cipher name')
                try:
