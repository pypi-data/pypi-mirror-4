...
library = Library("kotti_theme_cyborg", "static")
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_cyborg.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_cyborg.edit_needed'
