...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.sort_index'
        db.add_column('collection_photo', 'sort_index', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.sort_index'
        db.delete_column('collection_photo', 'sort_index')
