...
class StorageObject:
    ...
    def send(self, data, check_md5=True, headers=None):
        """ Uploads object data
        ...
        if 'Content-Type' not in headers:
            ...
            if not content_type:
                ...
                content_type = _type or mimetypes.guess_type(self.name)[0] or \
    ...
    def rename(self, new_obj, *args, **kwargs):
        ...
        return new_obj.make_request('PUT', headers={'Content-Length': '0'},
            formatter=_copy_to)
