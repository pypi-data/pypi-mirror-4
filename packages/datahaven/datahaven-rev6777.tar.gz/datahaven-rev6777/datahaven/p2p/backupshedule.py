...
def start_backup(dirName):
    ...
    dobackup.dobackup(bid, dirName, recursive_subfolders, webcontrol.OnBackupDataPacketResult, result)
    backup_db.AddDirBackup(dirName, bid, "in process", dir_size, time.time(), 0)
