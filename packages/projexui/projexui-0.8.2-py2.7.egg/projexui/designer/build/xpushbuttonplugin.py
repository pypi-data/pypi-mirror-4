...
from projexui.widgets.xpushbutton import XPushButton as WidgetClass

class XPushButtonPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XPushButtonPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xpushbutton'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XPushButton" name="XPushButton"/>'
