...
the new name is created and returned without user input."""
    ...
    def ShowCurrentFrame( self ):
        ...
        if not self.using_wxglvideo:
            kwargs['lineseg_widths'] = [params.ellipse_thickness] * len( lines_to_draw )

        self.img_wind.update_image_and_drawings( 'Ctraxmain', frame8, **kwargs )
