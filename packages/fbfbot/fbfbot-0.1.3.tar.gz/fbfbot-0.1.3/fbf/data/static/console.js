      ...
      var token = "";
      var consoletxt = '<br><form><b>&lt;-</b><input length="100" type="text" name="cmnd" onKeyPress="return doexec(this.form, event);" /><b>-&gt;</b></form><div class="body" background-color="pink" align="center" id="content_div"><i>Welcome to FBFBOT</i></div>';
      ...
      function setCookie() {
        var val = localStorage && localStorage.getItem("fbf_cookie");
        if (!val) {
            val = identtime.getTime();
            localStorage && localStorage.setItem("fbf_cookie", val);
        }
      } 
