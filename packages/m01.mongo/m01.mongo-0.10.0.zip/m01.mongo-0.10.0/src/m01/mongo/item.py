...
# TODO: dump data in in begin method and store data in cache
#       this makes sure that dump doesn't fail but only dump if
#       self.removed is False.
#       Clean up dumped cache in finish method
class MongoObject(base.MongoItemBase):
    ...
    def doInsert(self, manipulate=False, safe=False, check_keys=True,
