...
from projexui.widgets.xratingslider import XRatingSlider as WidgetClass

class XRatingSliderPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XRatingSliderPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xratingslider'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XRatingSlider" name="XRatingSlider"/>'
