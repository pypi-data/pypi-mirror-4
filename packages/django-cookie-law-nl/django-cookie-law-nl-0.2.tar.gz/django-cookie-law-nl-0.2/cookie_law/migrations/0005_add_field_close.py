...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cookie_law_cookiebar', 'close', self.gf('django.db.models.fields.BooleanField')(default='False'), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'CookieBar.button_title'
        db.delete_column('cookie_law_cookiebar', 'close')
