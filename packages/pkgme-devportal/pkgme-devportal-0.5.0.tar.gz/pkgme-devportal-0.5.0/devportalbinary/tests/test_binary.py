...
class BinaryBackendTests(BackendTests):
    ...
    def setUp(self):
        ...
        self.useFixture(
            LibdepFixture([('libc6', {'i386': {'libc.so.6': 'libc6'}}),
                           ('libfoo', {'i386': {'libasound.so.2': 'libfoo'}})]))
    ...
    def test_config_glue_lib_overrides(self):
        ...
        self.assertEqual(conf.libraries_overrides, test_libs)
    ...
    def test_get_lib_overrides_for_packages_for_libraries(self):
        ...
        self.assertEqual(
            get_packages_for_libraries(set(["libasound.so.2"]), "i386"),
            set(["libasound2"]))
