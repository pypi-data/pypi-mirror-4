...
from projexui.widgets.xcolortreewidget import XColorTreeWidget as WidgetClass

class XColorTreeWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XColorTreeWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcolortreewidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XColorTreeWidget" name="XColorTreeWidget"/>'
