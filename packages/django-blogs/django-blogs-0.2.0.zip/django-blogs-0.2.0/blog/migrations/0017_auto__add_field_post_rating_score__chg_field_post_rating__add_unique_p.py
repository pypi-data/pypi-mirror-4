...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_post', 'rating_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True, to=orm['ratings.Rating']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.rating'
        db.alter_column('blog_post', 'rating_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ratings.Rating']))
