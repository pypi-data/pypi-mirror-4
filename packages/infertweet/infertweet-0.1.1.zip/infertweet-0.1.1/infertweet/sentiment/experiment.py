...
def run_experiment(first, second, extractor, chunk_size, first_chunk=0):
    ...
    print 'remove me:', len(hierarchical_classifier.get_pickle_objects())
    ...
    try:
        ...
        print 'Saving final classifier'
        with open(r"D:\semeval-final.pickle", mode='wb') as f:
            pickle.dump(hierarchical_classifier.get_pickle_objects(), f,
