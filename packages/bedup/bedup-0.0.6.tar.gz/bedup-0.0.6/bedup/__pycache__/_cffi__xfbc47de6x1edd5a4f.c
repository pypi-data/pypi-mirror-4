...
static PyObject *
_cffi_f_openat(PyObject *self, PyObject *args)
{
  int x0;
  char const *  x1;
  int x2;
  ...
  if (!PyArg_ParseTuple(args, "OOO:openat", &arg0, &arg1, &arg2))
    return NULL;
  ...
  x1 = _cffi_to_c_char_p(arg1);
  if (x1 == (char const * )NULL && PyErr_Occurred())
    return NULL;
...
static PyMethodDef _cffi_methods[] = {
  {"openat", _cffi_f_openat, METH_VARARGS},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_cffi__xfbc47de6x1edd5a4f(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xfbc47de6x1edd5a4f", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
