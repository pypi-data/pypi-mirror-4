...
class Symbol(QGraphicsPolygonItem):
    ...
    default_cursor = Qt.SizeAllCursor  # Qt.ArrowCursor
...
class Comment(Symbol):
    ...
    def __init__(self, parent=None, ast=None):
        ...
        if parent:
            self.insert_symbol(parent, ast.pos_x, ast.pos_y)
    ...
    def mouse_release(self, event):
        ...
        for item in self.collidingItems():
            if isinstance(item, Symbol):  # (Connection, EditableText)):
                move_accepted = False
...
class VerticalSymbol(Symbol):
    ...
    def __init__(self, polygon, parent=None, text='...',
        ...
        if parent:
            self.insert_symbol(parent=parent, x=None, y=y)
        self.grabber.display()
