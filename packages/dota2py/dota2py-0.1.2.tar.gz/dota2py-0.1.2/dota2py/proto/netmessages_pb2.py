...
_SIGNONSTATE = descriptor.EnumDescriptor(
  name='SIGNONSTATE',
...
_CLC_MESSAGES = descriptor.EnumDescriptor(
  name='CLC_Messages',
...
_SVC_MESSAGES = descriptor.EnumDescriptor(
  name='SVC_Messages',
...
_ESPLITSCREENMESSAGETYPE = descriptor.EnumDescriptor(
...
_CMSGVECTOR = descriptor.Descriptor(
  name='CMsgVector',
...
_CMSGVECTOR2D = descriptor.Descriptor(
  name='CMsgVector2D',
...
_CMSGQANGLE = descriptor.Descriptor(
  name='CMsgQAngle',
...
_CMSG_CVARS_CVAR = descriptor.Descriptor(
  name='CVar',
...
_CMSG_CVARS = descriptor.Descriptor(
  name='CMsg_CVars',
...
_CNETMSG_NOP = descriptor.Descriptor(
  name='CNETMsg_NOP',
...
_CNETMSG_DISCONNECT = descriptor.Descriptor(
...
_CNETMSG_FILE = descriptor.Descriptor(
  name='CNETMsg_File',
...
_CNETMSG_SPLITSCREENUSER = descriptor.Descriptor(
...
_CNETMSG_TICK = descriptor.Descriptor(
  name='CNETMsg_Tick',
...
_CNETMSG_STRINGCMD = descriptor.Descriptor(
...
_CNETMSG_SETCONVAR = descriptor.Descriptor(
...
_CNETMSG_SIGNONSTATE = descriptor.Descriptor(
...
_CCLCMSG_CLIENTINFO = descriptor.Descriptor(
...
_CCLCMSG_MOVE = descriptor.Descriptor(
  name='CCLCMsg_Move',
...
_CCLCMSG_VOICEDATA = descriptor.Descriptor(
...
_CCLCMSG_BASELINEACK = descriptor.Descriptor(
...
_CCLCMSG_LISTENEVENTS = descriptor.Descriptor(
...
_CCLCMSG_RESPONDCVARVALUE = descriptor.Descriptor(
...
_CCLCMSG_FILECRCCHECK = descriptor.Descriptor(
...
_CCLCMSG_LOADINGPROGRESS = descriptor.Descriptor(
...
_CCLCMSG_SPLITPLAYERCONNECT = descriptor.Descriptor(
...
_CCLCMSG_CLIENTMESSAGE = descriptor.Descriptor(
...
_CSVCMSG_SERVERINFO = descriptor.Descriptor(
...
_CSVCMSG_CLASSINFO_CLASS_T = descriptor.Descriptor(
  name='class_t',
...
_CSVCMSG_SETPAUSE = descriptor.Descriptor(
...
_CSVCMSG_VOICEINIT = descriptor.Descriptor(
...
_CSVCMSG_PRINT = descriptor.Descriptor(
  name='CSVCMsg_Print',
...
_CSVCMSG_SOUNDS_SOUNDDATA_T = descriptor.Descriptor(
  name='sounddata_t',
...
_CSVCMSG_PREFETCH = descriptor.Descriptor(
...
_CSVCMSG_SETVIEW = descriptor.Descriptor(
...
_CSVCMSG_FIXANGLE = descriptor.Descriptor(
...
_CSVCMSG_CROSSHAIRANGLE = descriptor.Descriptor(
...
_CSVCMSG_BSPDECAL = descriptor.Descriptor(
...
_CSVCMSG_SPLITSCREEN = descriptor.Descriptor(
...
_CSVCMSG_GETCVARVALUE = descriptor.Descriptor(
...
_CSVCMSG_MENU = descriptor.Descriptor(
  name='CSVCMsg_Menu',
...
_CSVCMSG_SENDTABLE_SENDPROP_T = descriptor.Descriptor(
  name='sendprop_t',
...
_CSVCMSG_GAMEEVENT_KEY_T = descriptor.Descriptor(
  name='key_t',
...
_CSVCMSG_GAMEEVENTLIST_KEY_T = descriptor.Descriptor(
  name='key_t',
...
_CSVCMSG_PACKETENTITIES = descriptor.Descriptor(
...
_CSVCMSG_TEMPENTITIES = descriptor.Descriptor(
...
_CSVCMSG_CREATESTRINGTABLE = descriptor.Descriptor(
...
_CSVCMSG_UPDATESTRINGTABLE = descriptor.Descriptor(
...
_CSVCMSG_USERMESSAGE = descriptor.Descriptor(
...
_CSVCMSG_VOICEDATA = descriptor.Descriptor(
...
_CSVCMSGLIST_GAMEEVENTS_EVENT_T = descriptor.Descriptor(
  name='event_t',
...
_CSVCMSGLIST_USERMESSAGES_USERMSG_T = descriptor.Descriptor(
  name='usermsg_t',
...
class CSVCMsg_GameEvent(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  
  class key_t(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
...
class CSVCMsg_GameEventList(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  ...
  class descriptor_t(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
...
class CSVCMsgList_UserMessages(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  
  class usermsg_t(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
