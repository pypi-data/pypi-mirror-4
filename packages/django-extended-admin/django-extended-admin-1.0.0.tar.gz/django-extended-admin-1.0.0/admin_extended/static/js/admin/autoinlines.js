(function($) {
    $(function() {
        $.autoInline = function(options) {
            new AutoInlineConstruct(options).init();
        }
        ...
        function AutoInlineConstruct(options) {
            $.extend(this, {
                requiredMask: 1,
            ...
            this.requiredMask = this.castBoolArray(this.requiredMask.toString(), true);
        }

        AutoInlineConstruct.prototype.castBoolArray = function(array, mask) {
            var result = [];
        ...
        AutoInlineConstruct.prototype.getCheckboxes = function(index) {
            return $(this.sCheckboxes.format(this.controllers[index]))
        }
        
        AutoInlineConstruct.prototype.getRecords = function(checkbox, controller) {
            var self = this;
        ...
        AutoInlineConstruct.prototype.checkRecords = function(records) {
            var self = this;
            var result = [];
        ...
        AutoInlineConstruct.prototype.getRowByRecord = function(record) {
            var self = this;
            var result = $();
            var rows = [];
        ...
        AutoInlineConstruct.prototype.addDynamicLines = function(records) {
            var self = this;
            ...
            $.each(records, function(_, record) {
                ...
                row.exist(
                    function() {
                        $(this).removeClass("removed-row").show();
                    },
                    function() {
                        $("{0} .add-row a".format(self.sModule)).trigger('click');
        ...
        AutoInlineConstruct.prototype.removeDynamicLines = function(field, value) {
            var self = this;
            ...
            $.each(inputs, function() {
                ...
                if (row.hasClass("has_original")) {
                    row.find("td.delete input").attr("checked", "cheked");
                    row.addClass("removed-row").hide();
                }
                else {
                    row.find(".inline-deletelink").trigger("click");
                }
            })
        }

        AutoInlineConstruct.prototype.createSkeleton = function() {           
            var self = this;
        ...
        AutoInlineConstruct.prototype.bindClicks = function() {
            var self = this;
        ...
        AutoInlineConstruct.prototype.checkInlineContent = function() {        
        ...
        AutoInlineConstruct.prototype.acceptCSS = function() {
            var self = this;
        ...
        AutoInlineConstruct.prototype.init = function() {
            var self = this;
