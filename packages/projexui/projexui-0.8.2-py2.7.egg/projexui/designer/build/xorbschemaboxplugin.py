...
from projexui.widgets.xorbschemabox import XOrbSchemaBox as WidgetClass

class XOrbSchemaBoxPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbSchemaBoxPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbschemabox'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbSchemaBox" name="XOrbSchemaBox"/>'
