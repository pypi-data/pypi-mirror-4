...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_blog_images_entryimage', (
        ...
        db.send_create_signal('cmsplugin_blog_images', ['EntryImage'])


    def backwards(self, orm):
        # Deleting model 'EntryImage'
        db.delete_table('cmsplugin_blog_images_entryimage')
    ...
    models = {
        ...
        'cmsplugin_blog_images.entryimage': {
    ...
    complete_apps = ['cmsplugin_blog_images']