...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.product'
        db.add_column('collection_photo', 'product', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='photos', to=orm['collection.Product']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.product'
        db.delete_column('collection_photo', 'product_id')
