	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 na3 /home/mattions/Dev/Neuronvisio/examples/pyramidal/x86_64/na3h5.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("na3", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 90 in file na3h5.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
