/* Generated by Cython 0.17.4 on Tue Mar 26 16:54:44 2013 */
 ...
 *             self.redis.cmd("hget", (self.name, key)).reply()
 */
  __pyx_k_tuple_8 = PyTuple_New(3); if (unlikely(!__pyx_k_tuple_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
