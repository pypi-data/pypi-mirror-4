...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Country.iso3_code'
        db.alter_column('geo_country', 'iso3_code', self.gf('django.db.models.fields.CharField')(default='AAA', max_length=3, blank=False, null=False))
        db.alter_column('geo_country', 'num_code', self.gf('django.db.models.fields.CharField')(default='AAA', max_length=3, blank=False, null=False))

    def backwards(self, orm):

        # Changing field 'Country.iso3_code'
        db.alter_column('geo_country', 'iso3_code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True))
        db.alter_column('geo_country', 'num_code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True))
    ...
    models = {
        ...
        'geo.country': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iso3_code': ('django.db.models.fields.CharField', [], {'max_length': '3', 'db_index': 'True'}),
