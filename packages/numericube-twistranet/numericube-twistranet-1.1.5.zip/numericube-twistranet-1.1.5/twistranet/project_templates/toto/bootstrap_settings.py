"""
Parameters only used during the bootstraping process.
Changing this AFTER bootstraping will have no particular effect.
"""
# Default data loading. This is only used during bootstraping process.
