...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'MigratedObject.is_created'
        db.add_column('migrator_migratedobject', 'is_created', orm['migrator.migratedobject:is_created'])

    def backwards(self, orm):
        # Deleting field 'MigratedObject.is_created'
        db.delete_column('migrator_migratedobject', 'is_created')
