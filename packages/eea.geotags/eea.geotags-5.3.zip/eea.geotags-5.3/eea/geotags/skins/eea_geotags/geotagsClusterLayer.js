...
dojo.declare("GeotagsClusterLayer", esri.layers.GraphicsLayer, {
  ...
  */
  ...
  onClick: function(e) {
    ...
    var singles = [], i, il;
    for ( i = 0, il = this._clusterData.length; i < il; i+= 1) {
  ...
  */
  ...
  _clusterGraphics: function() {
    ...
    var j, jl;
    for ( j = 0, jl = this._clusterData.length; j < jl; j+= 1 ) {
  ...
  _showAllClusters: function() {
    var i, il;
    for ( i = 0, il = this._clusters.length; i < il; i+= 1 ) {
      var c = this._clusters[i];
      this._showCluster(c);
    }
  },
