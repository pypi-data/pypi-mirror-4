...
version = '[library version:2.3.5]'[17:-1]

setup(
    name='python-openid-lac',
    version=version,
...
and support for a variety of storage back-ends.''',
    url='http://github.com/mtgreenway/python-openid',
    packages=['openid',
              'openid.consumer',
              'openid.server',
              'openid.store',
    ...
    # license=getLicense(),
    author='Matt Greenway',
    author_email='mgreenway@uchicago.edu',
    download_url='http://github.com/mtgreenway/python-openid/tarball/%s' % (version,),
    classifiers=[
