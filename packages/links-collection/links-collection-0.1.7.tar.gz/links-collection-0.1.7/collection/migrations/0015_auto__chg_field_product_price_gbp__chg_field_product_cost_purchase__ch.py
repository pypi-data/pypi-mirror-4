...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('collection_product', 'price_usd', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Product.price_eur'
        db.alter_column('collection_product', 'price_eur', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Product.price_gbp'
        db.alter_column('collection_product', 'price_gbp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Product.cost_purchase'
        db.alter_column('collection_product', 'cost_purchase', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Product.cost_work'
        db.alter_column('collection_product', 'cost_work', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Product.price_usd'
        db.alter_column('collection_product', 'price_usd', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Product.price_eur'
        db.alter_column('collection_product', 'price_eur', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        'collection.product': {
            ...
            'cost_purchase': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
            'cost_work': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
            ...
            'price_gbp': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
