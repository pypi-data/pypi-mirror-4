...
class StoragePage(Page):
    ...
    def renderPage(self, request):
        ...
        StringNeeded = diskspace.MakeStringFromString(settings.getCentralMegabytesNeeded())
        ...
        StringDonated = diskspace.MakeStringFromString(settings.getCentralMegabytesDonated())
        ...
        StringUsedDonated = diskspace.MakeStringFromBytes(currentlyUsedDonatedSpace)
        PercNeed = 100.0 * bytesUsed / bytesNeeded
        PercAllocated = (100.0*totalCustomersMB/(totalCustomersMB+freeDonatedMB))
        PercDonated = (100.0*currentlyUsedDonatedSpace/((totalCustomersMB+freeDonatedMB)*1024*1024))
        src = ''
        src += '<h1>storage</h1>\n'
        src += '<table><tr>\n'
