...
define(['environ', 'mediator', 'jquery', 'underscore', 'backbone', 'serrano/channels', 'views/charts', 'forms/controls'], function(environ, mediator, $, _, Backbone, channels, Charts, Controls) {
  var ConceptItemView, QueryView, QueryViewFilterList, QueryViewsAccordian, QueryViewsPanel, QueryViewsSearchForm;
  QueryView = (function(_super) {
    ...
    QueryView.prototype.render = function() {
      var $controls, attrs, chart, control, controlClass, fields, model, options, _i, _len, _ref,
        _this = this;
      ...
      mediator.subscribe(channels.DATACONTEXT_SYNCED, function(model) {
        var conditions, _j, _len1, _ref1, _results;
        if (model.isSession()) {
          _ref1 = _this.controls;
          _results = [];
    ...
    QueryView.prototype.show = function() {
      var $parent, control, _i, _len, _ref;
      this.resolve();
  ...
  ConceptItemView = (function(_super) {
    ...
    function ConceptItemView() {
      return ConceptItemView.__super__.constructor.apply(this, arguments);
    }
  ...
  QueryViewsAccordian = (function(_super) {
    ...
    QueryViewsAccordian.prototype.render = function() {
      var $group, $list, attrs, cat, cats, id, model, models, name, sub, subcats, subtree, tree, view, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref;
      tree = {
        categories: []
      };
  ...
  QueryViewFilterList = (function(_super) {
    ...
    function QueryViewFilterList() {
      ...
      return QueryViewFilterList.__super__.constructor.apply(this, arguments);
    }
    ...
    QueryViewFilterList.prototype.initialize = function(options) {
      ...
      $('body').append(this.$el);
      this.$el.panel();
      mediator.subscribe(channels.DATACONTEXT_SYNCING, function() {
        return _this.$content.addClass('loading');
      });
      return mediator.subscribe(channels.DATACONTEXT_SYNCED, function(model) {
        if (model.isSession()) {
    ...
    QueryViewFilterList.prototype.render = function(model) {
      ...
      this.$content.html('<h4>Applied Filters</h4>');
      if (!node || _.isEmpty(node)) {
        this.$content.append('<div class=muted>No filters are applied</div>');
      } else {
    ...
    QueryViewFilterList.prototype.clear = function(event) {
      event.preventDefault();
      return mediator.publish(channels.DATACONTEXT_CLEAR);
    };
