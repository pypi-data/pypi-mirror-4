...
// lino.js --- generated Sun Mar 17 10:44:33 2013 by Lino version 1.6.2.
...
Lino.ui.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var welcome_htmlbox41 = new Lino.HtmlBoxPanel({ "flex": 5, "layout": "fit", "name": "welcome", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "region": "center", "title": "Welcome", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden", "split": true });
...
Lino.about.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var about_FieldsByModel_grid38 = new Lino.about.FieldsByModel.GridPanel({ "flex": 62, "hide_top_toolbar": true, "containing_panel": this, "viewConfig": { "emptyText": "No data to display." }, "tools": [ Lino.show_in_own_window_button(Lino.about.FieldsByModel.grid) ], "master_panel": this });
...
Lino.babel_tutorial.Products.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "Designation", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "dataIndex": "name", "editor": name45 }, { "colIndex": 1, "sortable": true, "header": "Designation (fr)", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(21), "dataIndex": "name_fr", "editor": name_fr46 }, { "colIndex": 2, "sortable": true, "header": "Category", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(14), "dataIndex": "category", "editor": category47 }, new Lino.NullNumberColumn({ "colIndex": 3, "sortable": true, "header": "Price", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(12), "dataIndex": "price", "editor": price48 }), new Lino.NullNumberColumn({ "colIndex": 4, "sortable": true, "format": "0", "editable": true, "filter": { "type": "numeric" }, "header": "ID", "renderer": Lino.id_renderer, "editor": id49, "width": Lino.chars2width(5), "dataIndex": "id" }) ];
...
Lino.lino.UserProfiles.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value69 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name70 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text71 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
...
Lino.lino.UserGroups.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value73 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name74 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text75 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
...
Lino.lino.UserLevels.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var value77 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var name78 = new Ext.form.TextField({ "disabled": true, "maxLength": 20 });
    var text79 = new Ext.form.TextField({ "disabled": true, "maxLength": 50 });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "width": Lino.chars2width(21), "colIndex": 0, "sortable": false, "dataIndex": "value", "header": "value", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 1, "sortable": false, "dataIndex": "name", "header": "name", "editable": false }, { "width": Lino.chars2width(21), "colIndex": 2, "sortable": false, "dataIndex": "text", "header": "text", "editable": false } ];
