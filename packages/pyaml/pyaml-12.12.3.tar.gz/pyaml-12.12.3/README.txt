...
`unidecode <http://pypi.python.org/pypi/Unidecode>`_ module
...
Module uses `PyYAML <http://pyyaml.org/>`_ for processing of the actual
YAML files and should pull it in as a dependency.

Dependency on `unidecode <http://pypi.python.org/pypi/Unidecode>`_
