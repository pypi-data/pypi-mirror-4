...
# Form implementation generated from reading ui file '/Users/dominik/Documents/Projekte/wallaby/wallaby-frontend-qt/wallaby/frontends/qt/isheet/iValueButton.ui'
#
# Created: Sun Dec 16 18:13:24 2012
...
class Ui_ILineEdit(object):
    ...
    def retranslateUi(self, ILineEdit):
        ...
        self.groupBox_4.setTitle(QtGui.QApplication.translate("ILineEdit", "Value-button settings", None, QtGui.QApplication.UnicodeUTF8))
        self.LineEdit.setProperty("template", QtGui.QApplication.translate("ILineEdit", "inspector-valuebutton-value", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ILineEdit", "value ==", None, QtGui.QApplication.UnicodeUTF8))
