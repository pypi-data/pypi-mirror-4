...
from projexui.widgets.xzoomslider import XZoomSlider as Base

class XZoomSliderPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(XZoomSliderPlugin, self).__init__(parent)
    ...
    def includeFile( self ):
        return 'projexui.widgets.xzoomslider'
    
    def domXml( self ):
        default = '<widget class="XZoomSlider" name="XZoomSlider"/>'
