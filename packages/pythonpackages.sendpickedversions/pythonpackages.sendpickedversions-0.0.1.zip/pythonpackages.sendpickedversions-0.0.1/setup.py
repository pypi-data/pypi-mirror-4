...
entry_point = 'pythonpackages.sendpickedversions:install'
...
setup(name='pythonpackages.sendpickedversions',
      version=version,
...
#      author_email='jukka.ojaniemi@jyu.fi',
      url='http://github.com/pythonpackages/pythonpackages.sendpickedversions',
      packages = find_packages('src'),
      package_dir = {'':'src'},
      namespace_packages=['pythonpackages'],
      include_package_data=True,
      zip_safe=False,
      install_requires=requires,
      tests_require=tests_require,
      extras_require=dict(tests=tests_require),
      test_suite = 'pythonpackages.sendpickedversions.tests.test_suite',
