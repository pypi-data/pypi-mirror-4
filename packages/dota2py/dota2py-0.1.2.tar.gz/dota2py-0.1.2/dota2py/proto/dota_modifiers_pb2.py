...
_CDOTAMODIFIERBUFFTABLEENTRY = descriptor.Descriptor(
...
_CDOTAMODIFIERBUFFTABLEENTRY.fields_by_name['v_start'].message_type = netmessages_pb2._CMSGVECTOR
_CDOTAMODIFIERBUFFTABLEENTRY.fields_by_name['v_end'].message_type = netmessages_pb2._CMSGVECTOR
DESCRIPTOR.message_types_by_name['CDOTAModifierBuffTableEntry'] = _CDOTAMODIFIERBUFFTABLEENTRY

class CDOTAModifierBuffTableEntry(message.Message):
