...
# Generated 2013-04-17 03:14:23.735270 by PyXB version 1.2.2
...
class STD_ANON (pyxb.binding.datatypes.Name, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/dc/schemas/dcmitype.xsd', 33, 8)
    _Documentation = None
...
class DCMIType (pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.u6onFwf/PyXB-1.2.2/pyxb/bundles/dc/schemas/dcmitype.xsd', 31, 2)
    _Documentation = None
