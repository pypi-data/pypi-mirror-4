...
from clitool.const import DEFAULT_ENCODING
...
def cliconfig(func):
    """ Annotation if function requires configuration data.

    First argument will be configuration data.
