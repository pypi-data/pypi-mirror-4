...
def setup_product():
    ...
    import medialog.hidedtitle
    zcml.load_config('configure.zcml', medialog.summaryview)
    ...
    ztc.installPackage('medialog.summaryview')
...
setup_product()
ptc.setupPloneSite(products=['medialog.summaryview'])

class FlagTestCase(ptc.PloneTestCase):
    """We use this base class for all the tests in this package. If necessary,
    we can put common utility or setup code in here. This applies to unit 
    test cases.
    """

class FlagFunctionalTestCase(ptc.FunctionalTestCase):
