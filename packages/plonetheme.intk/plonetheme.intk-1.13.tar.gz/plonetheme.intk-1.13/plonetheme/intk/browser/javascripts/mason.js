...
jq(function(){
    ...
    var open = function ()
    {
        ...
        var top = "-44px";
        var height = "-23px";
        //jq("#portal-logo").css("top",top);
        setTimeout(function (){jq("#portal-globalnav").css("top", height)},300);
    }
    ...
    var close = function ()
    {
        ...
        var top = "-75px";
        var height = "-300px";
        jq("#portal-globalnav").css("top", height);
        //setTimeout(function (){jq("#portal-logo").css("top",top)},300);
    }
    ...
    jq("#portal-logo").click(menuAction);
    jq("body").click(close);
