...
def stress_test():
    ...
    logging.error("TEST PASSED; please be patient for the sleep statement.") # Failure is seen with an exception.
    time.sleep(30) # Give the threads a chance to catch up before the next test.
