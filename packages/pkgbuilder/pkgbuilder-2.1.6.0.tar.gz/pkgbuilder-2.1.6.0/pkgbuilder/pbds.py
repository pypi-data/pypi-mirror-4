...
class PBDS():
    ...
    # This is invalid syntax in Python 2.  Fortunately, PKGBUILDer is
    # incompatible with Python 2 (blame pyalpm for this).  So we can happily do
    # this.  I’m wondering how much bullshit would I have to do.  I think that
    # ``*rargs, **kwargs`` would be enough.
