...
class display_volume_detail(DetailView):
    """Get all stat entries from database and analyze them to show:
        1) I/O stats for each client that reads/writes to LUNs of this volume only
        2) Total I/O load on volume LUNs
    ...
    def get_context_data(self, **kwargs):
        """Overriding the method to add client statistics into template context
