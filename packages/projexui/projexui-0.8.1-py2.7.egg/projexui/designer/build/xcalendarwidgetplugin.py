...
from projexui.widgets.xcalendarwidget import XCalendarWidget as WidgetClass

class XCalendarWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XCalendarWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcalendarwidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XCalendarWidget" name="XCalendarWidget"/>'
