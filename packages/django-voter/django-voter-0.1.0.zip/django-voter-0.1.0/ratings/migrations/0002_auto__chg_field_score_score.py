...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ratings_score', 'score', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Score.score'
        db.alter_column('ratings_score', 'score', self.gf('django.db.models.fields.IntegerField')())
