...
# Form implementation generated from reading ui file '/Users/dominik/Documents/Projekte/wallaby/wallaby-frontend-qt/wallaby/frontends/qt/isheet/iComboBox.ui'
#
# Created: Sun Dec 16 18:13:18 2012
...
class Ui_ILineEdit(object):
    ...
    def retranslateUi(self, ILineEdit):
        ...
        self.groupBox_4.setTitle(QtGui.QApplication.translate("ILineEdit", "Document data-source", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_4.setProperty("template", QtGui.QApplication.translate("ILineEdit", "inspector-groupbox-source", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_5.setTitle(QtGui.QApplication.translate("ILineEdit", "View data-source", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_5.setProperty("template", QtGui.QApplication.translate("ILineEdit", "inspector-groupbox-query", None, QtGui.QApplication.UnicodeUTF8))
