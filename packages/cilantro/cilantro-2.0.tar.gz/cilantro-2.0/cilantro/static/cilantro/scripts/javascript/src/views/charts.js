...
define(['environ', 'mediator', 'jquery', 'underscore', 'backbone', 'charts/utils', 'charts/backbone-charts'], function(environ, mediator, $, _, Backbone, ChartUtils) {
  var DataFieldDistribution, DistributionChart, chartTmpl;
    ...
    DistributionChart.prototype.update = function(url, data, fields, seriesIdx) {
      ...
      return Backbone.ajax({
        ...
        success: function(resp) {
          ...
          return _this.renderChart(ChartUtils.processResponse(resp, fields, seriesIdx));
        }
      });
    };
