...
public:
    ...
    virtual void module(formast::Module const &module);
    virtual void module_class(formast::Class const &class_);
    virtual void module_enum(formast::Enum const &enum_);
    virtual void stats(formast::Stats const &stats);
    virtual void stats_field(formast::Field const &field);
    virtual void stats_if(formast::If const &if_);
    virtual void enum_stats(formast::EnumStats const &stats);
    virtual void enum_stats_const(formast::EnumConst const &const_);
