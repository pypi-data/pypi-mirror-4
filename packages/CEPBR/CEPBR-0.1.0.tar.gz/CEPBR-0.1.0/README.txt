...
Inicialmente inspirada no postmon[1], a proposta era deixa-la mais simples e 
modular. Entretanto o projeto postmon utiliza uma url de busca dos site dos 
Correios do Brasil. Sua disponibilidade esta diretamente associada a 
disponibilidade dessa url.

A nova versão utiliza a API[2] de consulta a CEP do Correio Control da Aviso[3]
...
Lucas Magnum (Doctests e Refactoring)

Contato
=======

Mauro Navarro Baraldi (mauro.baraldi@gmail.com) github & twitter

Links
-----

[1] https://github.com/CodingForChange/postmon
[2] http://avisobrasil.com.br/api-de-consulta-de-cep/
[3] http://avisobrasil.com.br/
