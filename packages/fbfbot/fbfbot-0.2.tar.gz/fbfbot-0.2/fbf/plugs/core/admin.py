...
from fbf.lib.boot import savecmndtable, savepluginlist, boot, plugin_packages, clear_tables, getcmndtable, getcallbacktable
...
from fbf.utils.generic import stringsed, getwho
...
def handle_adminerrors(bot, ievent):
    ...
    from fbf.utils.log import errors
...
def handle_adminexceptions(bot, event):
    ...
    from fbf.utils.exception import exceptionlist, exceptionevents
