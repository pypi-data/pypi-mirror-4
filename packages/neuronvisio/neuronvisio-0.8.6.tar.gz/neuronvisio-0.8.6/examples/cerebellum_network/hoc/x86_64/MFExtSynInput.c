...
#define total total_MFExtSynInput
 double total = 0;
 ...
 "total_MFExtSynInput", &total_MFExtSynInput,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MFExtSynInput /home/mattions/Dev/Neuronvisio/examples/cerebellum_network/hoc/x86_64/MFExtSynInput.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: MFExtSynInput";
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 92 in file MFExtSynInput.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
