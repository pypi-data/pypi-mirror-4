...
class MyFrame(wx.Frame):
    def __init__(self, parent, ID, url):
        ...
        self.Bind(wx.EVT_MENU, self.OnTraffic, self.toolbar.AddSimpleTool(2, wxImage('icons/history32.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap(), 'Packet History', ''))
        self.Bind(wx.EVT_MENU, self.OnQueues, self.toolbar.AddSimpleTool(3, wxImage('icons/traffic32.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap(), 'Traffic', ''))
        self.Bind(wx.EVT_MENU, self.OnEvents, self.toolbar.AddSimpleTool(4, wxImage('icons/event32.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap(), 'Events', ''))
        self.Bind(wx.EVT_MENU, self.OnStates, self.toolbar.AddSimpleTool(5, wxImage('icons/states32-1.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap(), 'Automats', ''))
        self.toolbar.AddSeparator()
        self.Bind(wx.EVT_MENU, self.OnClose, self.toolbar.AddSimpleTool(6, wxImage('icons/exit32-3.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap(), 'Close', ''))
