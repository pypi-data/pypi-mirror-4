...
library = Library('kotti_theme_cerulean', 'static')
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_cerulean.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_cerulean.edit_needed'
