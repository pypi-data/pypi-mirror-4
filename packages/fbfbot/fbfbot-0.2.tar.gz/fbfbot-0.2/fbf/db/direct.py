...
from fbf.utils.generic import tolatin1
from fbf.utils.exception import handle_exception
from fbf.lib.datadir import getdatadir
from fbf.lib.errors import NoDbConnection, NoDbResult
...
class Db(object):
    ...
    @dblocked
    def execute(self, execstr, args=None, retry=1):
