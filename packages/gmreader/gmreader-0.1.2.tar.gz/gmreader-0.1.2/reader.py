		...
		for msg in reversed(msgs[0].split(' ')):
			...
			if ret == 'OK':
				...
				try:
					...
					print "Error: \"Make sure your operating system is compliant with gmreader (i.e. mac osx, linux, windows). If linux or windows(with cygwin), you must have espeak installed on your machine.\""
					sys.exit(1)
def main():
	parser = argparse.ArgumentParser(version='gmreader v0.1.0', description="Listen to your gmails instead of reading them. Let python do the talking.")  
