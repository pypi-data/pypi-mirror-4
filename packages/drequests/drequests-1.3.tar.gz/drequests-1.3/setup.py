...
if PY3:
    if py_version < (3, 2):
        raise RuntimeError('On Python 3, Drequests requires Python 3.2 or better')
else:
    if py_version < (2, 6):
        raise RuntimeError('On Python 2, Drequests requires Python 2.6 or better')
