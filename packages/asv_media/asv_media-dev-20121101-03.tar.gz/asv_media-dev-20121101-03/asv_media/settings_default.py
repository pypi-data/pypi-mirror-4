...
ASV_MEDIA__BACKBONE_LOCATION  = '{0}/lib/backbone-min.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__UNDERSCORE_LOCATION  = '{0}/lib/underscore-min.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__JSON_LOCATION  = '{0}/lib/json.min.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__JSON2_LOCATION  = '{0}/lib/json2.min.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__KNOCKOUT_LOCATION  = '{0}/lib/knockout-2.2.0.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__KNOCKBACK_FULL_STACK_LOCATION  = '{0}/lib/knockback-full-stack.min.js'.format(ASV_MEDIA__STATIC_ROOT)
ASV_MEDIA__KNOCKBACK_LOCATION  = '{0}/lib/knockback.min.js'.format(ASV_MEDIA__STATIC_ROOT)
#---------------------------------------------------------------
#---------------------------------------------------------------
