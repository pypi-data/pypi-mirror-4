...
class Plugin(object):
    ...
    # by default, support all registry types
    _pluginRegisterType = Type.Module | Type.Package | Type.RegistryFile
    ...
    def pluginRegisterType( cls ):
        ...
        """
        return cls._pluginRegisterType
    ...
    def pluginPath( cls ):
        ...
        :return     [<str>, ..]
        """
        if ( cls._pluginpath == None ):
            cls._pluginpath = []
        return cls._pluginpath
    ...
    def setPluginRegisterType( cls, registerType ):
        ...
        """
        cls._pluginRegisterType = registerType
