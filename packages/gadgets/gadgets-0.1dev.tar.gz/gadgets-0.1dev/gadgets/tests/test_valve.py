...
class TestValve(object):
    ...
    def test_gravity(self):
        ...
        self.sockets.send(
            'update',
            {
                'bucket': {'volume': {'value': 1, 'units': 'liters'}},
                'barrel': {'volume': {'value': 3, 'units': 'liters'}}
            }
        )
        time.sleep(0.3)
        eq_(self.gadgets.coordinator._state['locations']['bucket']['valve']['value'], False)
        eq_(self.gadgets.coordinator._state['locations']['barrel']['volume']['value'], 3)
        eq_(self.gadgets.coordinator._state['locations']['bucket']['volume']['value'], 1)
        ...
        eq_(self.gadgets.coordinator._state['locations']['barrel']['volume']['value'], 2)
        eq_(self.gadgets.coordinator._state['locations']['bucket']['volume']['value'], 2)
    ...
    def test_timer_trigger_valve(self):
        ...
        eq_(status['locations']['barrel']['volume']['value'], 0)
        eq_(status['locations']['bucket']['volume']['value'], 4)
        self.sockets.send('shutdown')
