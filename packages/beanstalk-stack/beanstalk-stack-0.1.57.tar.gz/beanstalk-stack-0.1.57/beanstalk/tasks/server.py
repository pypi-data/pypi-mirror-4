        ...
        with lcd(tmp_directory):
            ...
            with settings(hide('everything'), warn_only=True):
                ...
                if has_uwsgi:
                    ...
                    print 'Current uWSGI version: {0}'.format('.'.join(current_version))
                    print 'New LTS uWSGI version: {0}'.format('.'.join(new_version))
            ...
            if install_uwsgi:
                print 'Install uwsgi {0}'.format('.'.join(new_version))
