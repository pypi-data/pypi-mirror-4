...
from projexui.widgets.xorbrecordedit import XOrbRecordEdit as WidgetClass

class XOrbRecordEditPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbRecordEditPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbrecordedit'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbRecordEdit" name="XOrbRecordEdit"/>'
