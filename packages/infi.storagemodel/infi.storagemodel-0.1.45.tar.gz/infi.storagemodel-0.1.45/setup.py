...
SETUP_INFO = dict(
    ...
    install_requires = ['infi.asi>=0.3.6', 'infi.hbaapi>=0.1.20', 'infi.multipathtools>=0.1.17', 'infi.diskmanagement>=0.1.21', 'infi.parted>=0.1.16', 'infi.mountoolinux>=0.1.6', 'infi.wioctl>=0.1', 'infi.exceptools>=0.2.2', 'distribute>=0.6.31', 'infi.cwrap>=0.2.4', 'daemon>=1.0', 'infi.dtypes.wwn>=0.0.2', 'Brownie', 'infi.wmpio>=0.1.15', 'infi.devicemanager>=0.2.1', 'infi.dtypes.hctl>=0.0.6', 'infi.sgutils>=0.1.1', 'infi.pyutils>=0.0.27', 'infi.instruct>=0.6.2', 'infi.traceback>=0.3.3'],
