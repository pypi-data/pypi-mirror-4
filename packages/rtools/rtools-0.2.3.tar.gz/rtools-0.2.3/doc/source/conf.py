...
try:
    import cnolab.deploy
    from cnolab.deploy import get_path_sphinx_themes
except Exception, e:
    print "Install cnolab.deploy or set your PYTHONPATH properly"
    raise Exception
...
extensions = [
    ...
    'sphinx.ext.ifconfig',
    'sphinx.ext.viewcode',
    'cnolab.deploy.copybutton',
    'matplotlib.sphinxext.plot_directive',
    'matplotlib.sphinxext.only_directives',
    ]

todo_include_todos=True
jscopybutton_path = cnolab.deploy.copybutton.get_copybutton_path()
