...
model.sens_state_0.setValue(model.eta1, 1)
model.sens_state_1.setValue(model.eta1, 1)
model.sens_state_value_1.setValue(model.eta1, perturbed_eta1)
model.sens_state_0.setValue(model.eta2, 2)
model.sens_state_1.setValue(model.eta2, 2)
model.sens_state_value_1.setValue(model.eta2, perturbed_eta2)
model.sens_init_constr.setValue(model.consteta1, 1)
model.sens_init_constr.setValue(model.consteta2, 2)
###
...
for v in [model.x1, model.x2, model.x3, model.eta1, model.eta2]:
    print "%5s %14g %14g" % (v, value(v), model.sens_sol_state_1.getValue(v))
###
