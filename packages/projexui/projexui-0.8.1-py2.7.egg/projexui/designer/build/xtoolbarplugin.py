...
from projexui.widgets.xtoolbar import XToolBar as WidgetClass

class XToolBarPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XToolBarPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xtoolbar'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XToolBar" name="XToolBar"/>'
