...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.introduction_text'
        db.add_column('collection_category', 'introduction_text', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.introduction_text'
        db.delete_column('collection_category', 'introduction_text')
