...
from projexui.widgets.xconsolestatusbar import XConsoleStatusBar as WidgetClass

class XConsoleStatusBarPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XConsoleStatusBarPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xconsolestatusbar'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XConsoleStatusBar" name="XConsoleStatusBar"/>'
