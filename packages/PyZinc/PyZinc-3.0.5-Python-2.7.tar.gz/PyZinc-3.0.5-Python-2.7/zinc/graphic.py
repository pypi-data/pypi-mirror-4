...
class Graphic(_object):
    ...
    USE_ELEMENT_TYPE_INVALID = _graphic.Graphic_USE_ELEMENT_TYPE_INVALID
    USE_ELEMENT_HIGHEST_DIMENSION = _graphic.Graphic_USE_ELEMENT_HIGHEST_DIMENSION
    USE_ELEMENT_FACES = _graphic.Graphic_USE_ELEMENT_FACES
    USE_ELEMENT_LINES = _graphic.Graphic_USE_ELEMENT_LINES
    ...
    def setUseElementType(self, *args): return _graphic.Graphic_setUseElementType(self, *args)
