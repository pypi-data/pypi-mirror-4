...
class DictModel(models.Model):
    ...
    def dict(self, json_serializable=False, summary=False):
    ...
    def json_dict(self, use_float_seconds=True, summary=False):
        ...
        """
        return json_model_dict(self.dict(json_serializable=True, summary=summary), use_float_seconds=use_float_seconds)
