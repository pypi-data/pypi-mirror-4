...
#                    src += '<b>%s %s</b>.\n' % (str(int(delta_dt)), delta_suf)
        ...
        if os.path.isfile(self.restorePath) and time.time() - os.path.getmtime(self.restorePath) < 60 * 60 and os.path.getsize(self.restorePath)>0: # made in last hour and is not empty
