...
static PyObject *
_cffi_f_fstat(PyObject *self, PyObject *args)
{
  int x0;
  struct stat*  x1;
  int result;
  ...
  if (!PyArg_ParseTuple(args, "OO:fstat", &arg0, &arg1))
    return NULL;
  ...
  x1 = (struct stat* )_cffi_to_c_pointer(arg1, _cffi_type(0));
  if (x1 == (struct stat* )NULL && PyErr_Occurred())
    return NULL;
...
static void _cffi_check_struct_stat(struct stat *p)
{
  ...
  { struct timespec(*tmp) = &p->st_atim; (void)tmp; }
  { struct timespec(*tmp) = &p->st_mtim; (void)tmp; }
}
static PyObject *
_cffi_layout_struct_stat(PyObject *self, PyObject *noarg)
{
...
static PyObject *
_cffi_f_futimens(PyObject *self, PyObject *args)
{
  int x0;
  struct timespec*  x1;
  int result;
  ...
  if (!PyArg_ParseTuple(args, "OO:futimens", &arg0, &arg1))
    return NULL;
  ...
  x1 = (struct timespec* )_cffi_to_c_pointer(arg1, _cffi_type(1));
  if (x1 == (struct timespec* )NULL && PyErr_Occurred())
    return NULL;

  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = futimens(x0, x1); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyMethodDef _cffi_methods[] = {
  {"fstat", _cffi_f_fstat, METH_VARARGS},
  {"_cffi_layout_struct_stat", _cffi_layout_struct_stat, METH_NOARGS},
  {"_cffi_layout_struct_timespec", _cffi_layout_struct_timespec, METH_NOARGS},
  {"futimens", _cffi_f_futimens, METH_VARARGS},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_cffi__x8d12ba84xa776430d(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x8d12ba84xa776430d", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
