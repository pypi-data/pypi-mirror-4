...
from projexui.widgets.xorbbrowserwidget import XOrbBrowserWidget as WidgetClass

class XOrbBrowserWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XOrbBrowserWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xorbbrowserwidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XOrbBrowserWidget" name="XOrbBrowserWidget"/>'
