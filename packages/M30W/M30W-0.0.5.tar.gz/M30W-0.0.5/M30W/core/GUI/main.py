...
import sys
import traceback
from core.debug import debug, DEBUG
...
class App(wx.App):
    def __init__(self):
        ...
        if DEBUG: sys.excepthook = excepthook
    def CreateGUI(self):
        ...
        menubar = MenuBar(self.mainFrame, menus)
...
def init_app():
    ...
    global menus, MenuBar, MainFrame
    from .menu import menus, MenuBar
    debug("Done.", -1)
