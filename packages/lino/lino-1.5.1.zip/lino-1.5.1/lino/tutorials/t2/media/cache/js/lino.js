// lino.js --- generated Sat Aug 13 16:46:23 2011 by Lino version 1.2.1.
...
Lino.users.Users.grid = function(caller,params) { 
  var ww = new Lino.GridMasterWrapper(caller,{ "content_type": 11, "action_name": "grid" },params);
...
Lino.lino.SiteConfigs.detail = function(caller,params) { 
  var ww = new Lino.DetailWrapper(caller,{ "content_type": 6, "name": "detail", "url_data": "/api/lino/SiteConfigs", "fk_name": null, "action_name": "detail", "active_fields": [  ] },params);
...
Lino.lino.SiteConfigs.insert = function(caller,params) { 
  var ww = new Lino.InsertWrapper(caller,{ "content_type": 6, "name": "insert", "url_data": "/api/lino/SiteConfigs", "record_id": -99999, "fk_name": null, "action_name": "insert", "active_fields": [  ] },params);
...
Lino.lino.TextFieldTemplates.detail = function(caller,params) { 
  var ww = new Lino.DetailWrapper(caller,{ "content_type": 8, "name": "detail", "url_data": "/api/lino/TextFieldTemplates", "fk_name": null, "action_name": "detail", "active_fields": [  ] },params);
...
Lino.lino.TextFieldTemplates.insert = function(caller,params) { 
  var ww = new Lino.InsertWrapper(caller,{ "content_type": 8, "name": "insert", "url_data": "/api/lino/TextFieldTemplates", "record_id": -99999, "fk_name": null, "action_name": "insert", "active_fields": [  ] },params);
...
Lino.lino.TextFieldTemplates.grid = function(caller,params) { 
  var ww = new Lino.GridMasterWrapper(caller,{ "content_type": 8, "action_name": "grid" },params);
...
Lino.polls.Polls.detail = function(caller,params) { 
  var ww = new Lino.DetailWrapper(caller,{ "content_type": 9, "name": "detail", "url_data": "/api/polls/Polls", "fk_name": null, "action_name": "detail", "active_fields": [  ] },params);
...
Lino.polls.Polls.insert = function(caller,params) { 
  var ww = new Lino.InsertWrapper(caller,{ "content_type": 9, "name": "insert", "url_data": "/api/polls/Polls", "record_id": -99999, "fk_name": null, "action_name": "insert", "active_fields": [  ] },params);
...
Lino.polls.Polls.grid = function(caller,params) { 
  var ww = new Lino.GridMasterWrapper(caller,{ "content_type": 9, "action_name": "grid" },params);
...
Lino.polls.Choices.grid = function(caller,params) { 
  var ww = new Lino.GridMasterWrapper(caller,{ "content_type": 10, "action_name": "grid" },params);
...
Lino.lino.DataControlListingReport.detail = function(caller,params) { 
  var ww = new Lino.DetailWrapper(caller,{ "content_type": 7, "name": "detail", "url_data": "/api/lino/DataControlListingReport", "fk_name": null, "action_name": "detail", "active_fields": [  ] },params);
...
Lino.lino.DataControlListingReport.listing = function(caller,params) { 
  var ww = new Lino.InsertWrapper(caller,{ "content_type": 7, "name": "listing", "url_data": "/api/lino/DataControlListingReport", "record_id": -99999, "fk_name": null, "action_name": "listing", "active_fields": [  ] },params);
...
Lino.lino.MyTextFieldTemplates.detail = function(caller,params) { 
  var ww = new Lino.DetailWrapper(caller,{ "content_type": 8, "name": "detail", "url_data": "/api/lino/MyTextFieldTemplates", "fk_name": "user", "action_name": "detail", "active_fields": [  ] },params);
...
Lino.lino.MyTextFieldTemplates.insert = function(caller,params) { 
  var ww = new Lino.InsertWrapper(caller,{ "content_type": 8, "name": "insert", "url_data": "/api/lino/MyTextFieldTemplates", "record_id": -99999, "fk_name": "user", "action_name": "insert", "active_fields": [  ] },params);
