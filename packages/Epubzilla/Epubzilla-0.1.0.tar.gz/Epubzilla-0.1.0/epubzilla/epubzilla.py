...
class Epub(object):
    ...
    def from_file(epub_file):
        ...
        for element in element_map:
            ...
            # We already know the appropriate namespace for each element, so this should be OK
            ...
            # a reference to the manifest so it can access. This will enable
            # the spine to access manifeset elements directly
