...
# Form implementation generated from reading ui file '/Users/dominik/Documents/Projekte/wallaby/wallaby-frontend-qt/wallaby/frontends/qt/isheet/iPrefController.ui'
#
...
class Ui_ILineEdit(object):
    ...
    def retranslateUi(self, ILineEdit):
        ...
        self.groupBox_4.setTitle(QtGui.QApplication.translate("ILineEdit", "Preferences sheet\'s settings", None, QtGui.QApplication.UnicodeUTF8))
        self.LineEdit.setProperty("template", QtGui.QApplication.translate("ILineEdit", "inspector-configdocid", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ILineEdit", "Id of config document", None, QtGui.QApplication.UnicodeUTF8))
