...
for k,v in _alphabet_to_bits.iteritems():
    for i in v:
        _bit3_to_dna[i] = k
_bit3_to_dna = bytes(''.join(_bit3_to_dna))
del(k, v, i)

_dna_to_bit3 = array('i', (_alphabet_to_bits[b'N'][0] for x in xrange(255)))
