...
from projexui.widgets.xviewwidget import XViewProfileToolBar as WidgetClass

class XViewProfileToolBarPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XViewProfileToolBarPlugin, self).__init__( parent )
    ...
    def domXml( self ):
        ...
        return '<widget class="XViewProfileToolBar" name="XViewProfileToolBar"/>'
