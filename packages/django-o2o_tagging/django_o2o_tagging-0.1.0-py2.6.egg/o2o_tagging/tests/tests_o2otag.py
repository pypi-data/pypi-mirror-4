...
class O2OTagManagerTest(TestCase):
    ...
    def test_for_tagged_in__and__for_tagged_in(self):
        ...
        tag = O2OTag.objects.tag(tagger, tagged, tagged_in)
        tag1 = O2OTag.objects.tag(tagger, tagged, tagged_in1)
        tag2 = O2OTag.objects.tag(tagger1, tagged, tagged_in)
        tag3 = O2OTag.objects.tag(tagger1, tagged, tagged_in1)

        tags = O2OTag.objects.for_tagged_in(tagged_in).for_tagger(tagger)
