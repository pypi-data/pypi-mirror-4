...
class mcuModule:
    ...
    @checkActive
    def pwmPeriod(self, preScaler, postScaler, tmrOffset, prOffset):
        """Set PWM period frequency
        Usage: pwmDuty(preScaler, postScaler, timerOffset, prOffset)
        Example:  pwmDuty(0, 3, 0, 150)"""
        self.mcuserial.write('P' + chr(tmrOffset) + chr(prOffset))
        if preScaler == 1:
            preScaler = 0
        elif preScaler == 4:
            preScaler = 1
        ...
        self.mcuserial.write(chr(t4con))
