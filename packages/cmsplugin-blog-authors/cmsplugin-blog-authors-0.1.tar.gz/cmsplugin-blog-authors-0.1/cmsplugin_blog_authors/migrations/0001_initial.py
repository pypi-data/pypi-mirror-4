...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_blog_authors_entryauthor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authors', to=orm['cmsplugin_blog.Entry'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['people.Person'])),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('cmsplugin_blog_authors', ['EntryAuthor'])


    def backwards(self, orm):
        # Deleting model 'EntryAuthor'
        db.delete_table('cmsplugin_blog_authors_entryauthor')
    ...
    models = {
        ...
        'cmsplugin_blog_authors.entryauthor': {
            'Meta': {'ordering': "['position']", 'object_name': 'EntryAuthor'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['people.Person']"}),
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authors'", 'to': "orm['cmsplugin_blog.Entry']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['cmsplugin_blog_authors']
