...
from projexui.widgets.xcurrencyspinbox import XCurrencySpinBox as WidgetClass

class XCurrencySpinBoxPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XCurrencySpinBoxPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcurrencyspinbox'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XCurrencySpinBox" name="XCurrencySpinBox"/>'
