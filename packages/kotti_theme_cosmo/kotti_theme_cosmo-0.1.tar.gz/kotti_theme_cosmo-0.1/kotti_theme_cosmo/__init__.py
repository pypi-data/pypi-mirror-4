...
library = Library('kotti_theme_cosmo', 'static')
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_cosmo.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_cosmo.edit_needed'