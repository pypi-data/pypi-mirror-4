...
"""Class for calculating the Fresnel coefficients for light incident on an
planar interface between two isotropic dielectric medium.
"""
import numpy as N
...
if __name__=="__main__":
    ...
    ax1.plot(theta,I.r_s().real,label="r_s")
    ax1.plot(theta,I.r_p().real,label="r_p")
    ax1.plot(theta,I.t_s().real,label="t_s")
    ax1.plot(theta,I.t_p().real,label="t_p")
    ax1.legend()
