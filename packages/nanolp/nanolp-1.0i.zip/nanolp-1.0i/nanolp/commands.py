...
class UseCmd(core.Cmd):
    ...
    def onpost(self, parser=None, flush=None):
        ...
        inclparser = core.Parser.create_parser(parser.engine, self.infile, fmt=fmt)
        inclparser.parsefile(self.infile, flush=False, outdir=parser.outdir)
...
class OnCmd(core.Cmd):
    ...
    def __ondefine__(self, parser=None, chunktext=None):
        ...
        if len(self.path) > 2:
            ...
            func = core.FuncChain().parse(functext)
