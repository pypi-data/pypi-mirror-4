...
class when_the_json_serializer_is_used(unittest.TestCase):
    """The JsonSerializer is a simple json serializer."""
    expected = {
...
class when_the_dropin_json_serializer_is_used(unittest.TestCase):
    """The DropinJsonSerializer at this point is a replacement for the old to_json
    method."""
    expected = {
        "cnames": [{'record': 'aa.record'}],
        "instances": 2,
