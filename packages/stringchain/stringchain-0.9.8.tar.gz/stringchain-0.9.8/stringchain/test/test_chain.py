...
stringchain.stringchain.debug = True
...
class T(unittest.TestCase):
    ...
    def test_popleft_at_least_new_stringchain(self):
        c = BufClass()
        c.append("ab")
        s = c.popleft_at_least_new_stringchain(1)
        self.failUnlessEqual(str(s), "ab")
        self.failUnlessEqual(str(c.copy()), "")
        s = c.popleft_at_least_new_stringchain(1)
        self.failUnlessEqual(str(s), "")
        self.failUnlessEqual(str(c.copy()), "")
        ...
        c.append("abc")
        s = c.popleft_at_least_new_stringchain(2)
        self.failUnlessEqual(str(s), "abc")
        self.failUnlessEqual(str(c.copy()), "")
        s = c.popleft_at_least_new_stringchain(1)
        self.failUnlessEqual(str(s), "")
        ...
        c.append("abc")
        s = c.popleft_at_least_new_stringchain(4) # We just silently pop them all.
        self.failUnlessEqual(str(s), "abc")
        self.failUnlessEqual(str(c.copy()), "")

    def test_popall_new_stringchain(self):
        c = BufClass()
        c.append("ab")
        s = c.popall_new_stringchain()
        self.failUnlessEqual(str(s), "ab")
        self.failUnlessEqual(str(c.copy()), "")
        s = c.popall_new_stringchain()
        self.failUnlessEqual(str(s), "")
    ...
    def test_popleft_at_least(self):
        c = BufClass()
        c.append("ab")
        s = c.popleft_at_least(1)
        self.failUnlessEqual(s, "ab")
        self.failUnlessEqual(str(c.copy()), "")
        s = c.popleft_at_least(1)
        ...
        c.append("abc")
        s = c.popleft_at_least(4) # We just silently pop them all.
        self.failUnlessEqual(s, "abc")
        self.failUnlessEqual(str(c.copy()), "")
