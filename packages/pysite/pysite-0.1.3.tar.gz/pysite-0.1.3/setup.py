...
setup(
	...
	data_files= [
		('resources/init/static/css',['resources/init/static/css/main.css']),
		('resources/init/static/images',['resources/init/static/images/splash-background.png']),
		('resources/init/templates',['resources/init/templates/main.jinja']),
	],
	zip_safe=False
)
