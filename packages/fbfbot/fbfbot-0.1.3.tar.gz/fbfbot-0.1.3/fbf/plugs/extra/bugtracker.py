...
from fbf.utils.url import geturl, geturl2, striphtml, useragent
...
examples.add('bug-set', 'set a bugtracker for the channel', 'bug-set googletracker https://code.google.com/feeds/issues/p/fbfbot/issues/full')
