...
from projexui.widgets.xpopupbutton import XPopupButton as WidgetClass

class XPopupButtonPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XPopupButtonPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xpopupbutton'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XPopupButton" name="XPopupButton"/>'
