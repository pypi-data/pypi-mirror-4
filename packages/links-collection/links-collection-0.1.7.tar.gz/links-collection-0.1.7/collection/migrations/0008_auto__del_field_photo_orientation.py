...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('collection_photo', 'orientation')


    def backwards(self, orm):
        
        # Adding field 'Photo.orientation'
        db.add_column('collection_photo', 'orientation', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)
