...
# TODO: dump object data to cache, which makes sure that dump doesn't fail
...
# TODO: use count, don't load data
...
# TODO: use cached dump data set by doInsert or doUpdate
    def vote(self):
