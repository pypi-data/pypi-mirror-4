...
import mushroom
from mushroom.geventfd import GeventFD
...
class ServerControl(object):
    ...
    def read_from_stdout(self):
        for line in GeventFD(self.proc.stdout).readlines():
            d = json.loads(line)
...
class SeleniumTestCase(object):
    ...
    def setUpClass(cls):
        ...
        logging.getLogger('selenium.webdriver.firefox').setLevel(logging.WARNING)
        logging.getLogger('selenium.webdriver.firefox.extension_connection').setLevel(logging.WARNING)
        logging.getLogger('selenium.webdriver.remote.remote_connection').setLevel(logging.WARNING)
        logging.getLogger('selenium.webdriver.remote.utils').setLevel(logging.WARNING)
        ...
        p.set_preference('extensions.logging.enabled', 'false')
