...
from fbf.utils.locking import locked
from fbf.utils.generic import strippedtxt, stripcolor
...
examples.add("forward-add" , "add a bot JID to forward to", "forward-add fbfbot@")
...
examples.add("forward-del" , "delete an JID to forward to", "forward-del fbfbot@")
...
examples.add("forward-allow" , "allow an JID to forward to us", "forward-allow fbfbot@")
...
examples.add("forward" , "forward a channel to provided JIDS", "forward fbfbot@")
...
examples.add("forward-stop" , "stop forwarding a channel to provided JIDS", "forward-stop fbfbot@")
