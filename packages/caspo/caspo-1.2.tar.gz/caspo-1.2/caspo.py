...
if __name__ == '__main__':
    ...
    parser.add_option("-p", "--discrete", dest="pvalue", type="int", default=2,
                      help="discretization over the integer interval: [0,10^P] (Default to 2)", metavar="P")
    ...
    models, score, optsize, data, instance = bioasp.optimize(pkn,midas,options.tolerance,options.pvalue)
