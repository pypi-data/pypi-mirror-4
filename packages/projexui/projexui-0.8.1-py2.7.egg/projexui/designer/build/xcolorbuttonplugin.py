...
from projexui.widgets.xcolorbutton import XColorButton as WidgetClass

class XColorButtonPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XColorButtonPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xcolorbutton'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XColorButton" name="XColorButton"/>'
