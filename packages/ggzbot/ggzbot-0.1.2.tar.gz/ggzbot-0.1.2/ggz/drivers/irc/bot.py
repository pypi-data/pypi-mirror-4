...
from ggz.utils.generic import waitforqueue, uniqlist, strippedtxt
from ggz.lib.commands import cmnds
from ggz.lib.callbacks import callbacks
from ggz.lib.plugins import plugs as plugins
from ggz.lib.threads import start_new_thread, threaded
from ggz.utils.dol import Dol
from ggz.utils.pdod import Pdod
from ggz.lib.persiststate import PersistState
from ggz.lib.errors import NoSuchCommand
...
from ggz.lib.wait import waiter
...
class IRCBot(Irc):
    ...
    def _dodcc(self, sock, nick, userhost, channel=None):
        ...
        if not nick or not userhost: return
        try:
            sock.send(bytes('Welcome to the JSONBOT partyline ' + nick + " ;]\n", self.encoding or "utf-8"))
