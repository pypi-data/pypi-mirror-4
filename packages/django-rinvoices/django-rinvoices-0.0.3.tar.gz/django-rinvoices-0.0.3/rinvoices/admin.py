...
class AdminInvoices(admin.ModelAdmin):
    ...
    def get_PDF(self, obj):
        return '<a href="/rinvoices/PDF/%s">PDF</a>, <a href="/rinvoices/txtPDF/%s">TXT</a>' % (str(obj.invoice_number), str(obj.invoice_number))
    ...
    def save_model(self, request, obj, form, change):
        ...
        obj.total = obj.subtotal + obj.subtotal_iva
        obj.save()
