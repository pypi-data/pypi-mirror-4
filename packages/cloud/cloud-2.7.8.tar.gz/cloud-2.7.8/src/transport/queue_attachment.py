    ...
    def attachment():
        ...
        while not shutting_down[0]:
            ...
            try:
                ...
                cloudLog.info('Got QueueFull exception. Possibly kill signal?')
        ...
        for _ in xrange(readers_per_job):
            try:
                ...
                if req_shutdown:
                    ...
                    cloudLog.info('Got QueueFull exception in sentinel handling. Possibly kill signal?')
                    raise SystemExit('Killed')
        ...
        for p in all_processes:
            p.join(min(1,max_time - time.time()))       
