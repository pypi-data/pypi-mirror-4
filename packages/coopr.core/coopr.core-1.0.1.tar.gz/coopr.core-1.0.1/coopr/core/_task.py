...
class ICooprTask(pyutilib.component.core.Interface):
    """Interface for Coopr tasks"""

CooprAPIFactory = pyutilib.component.core.CreatePluginFactory(ICooprTask)


class CooprTask(pyutilib.workflow.TaskPlugin):

    def __init__(self, *args, **kwargs):
        self._fn = kwargs.pop('fn', None)
        #
        pyutilib.workflow.TaskPlugin.__init__(self, *args, **kwargs)
    ...
    def _call_init(self, *options, **kwds):
        ...
        self._kwds = kwds
        return pyutilib.workflow.TaskPlugin._call_init(self, **kwds)
    ...
    def _call_fini(self, *options, **kwds):
        ...
        pyutilib.workflow.TaskPlugin._call_fini(self, *options, **kwds)
        return self._retval
    ...
    def my_decorator(fn):
        ...
        class TaskMeta(pyutilib.component.core.PluginMeta):
            def __new__(cls, name, bases, d):
                return pyutilib.component.core.PluginMeta.__new__(cls, "CooprTask_"+str(_name), bases, d)


        class CooprTask_tmp(CooprTask):

            __metaclass__ = TaskMeta

            pyutilib.component.core.alias(_alias)

            pyutilib.component.core.implements(ICooprTask, service=False)
