...
class CloudMonitor(Cloud):
    ...
    def getChecks(self, entityId,attrDict={}):
        """
    ...
    def getCheckTypes(self,attrDict={}):
        """
    ...
    def getAlarms(self, entityId, attrDict={}):
        """
        ...
        self.queryDict()
        log.info("getAccount GET to %s" % self.endpoint)
        return self.apiRequest(self.endpoint, "GET", self.postData, returnResults=True)
    ...
    def updateAlarm(self, entityId, alarmId, attrDict={}):
        ...
        Update an alarm with the specified alarmId. Partial updates to an alarm are acceptable. You may 
        specify only the parameters you would like to update.
    ...
    def getNotifications(self,attrDict={}):
        """
        Lists notifications.
