...
class MonitorTransportsPage(Page):
    ...
    def renderPage(self, request):
        ...
        for info in transfers:
            ...
            index[info.remote_idurl][info.send_or_receive].append((info.transfer_id, info.proto, info.size, info.description))
        src = ''
        ...
        for idurl in sorted(index.keys()):
            ...
            if contact_status.isOnline(idurl):
                ...
                color = 'gray'
            src += '<td align=center nowrap><b><font color=%s>%d,%d | %s | %d,%d</font></b></td>\n' % (
                color, 
