...
try:
    ...
    except AttributeError: # Very old cET use ET modules _namespace_map
        import xml.etree.ElemenTree
        _namespace_map = xml.etree.ElemenTree._namespace_map
...
except: # ET version <1.3 doesn't have register_namespace.
