...
from projexui.widgets.xsplitter import XSplitter as WidgetClass

class XSplitterPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XSplitterPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xsplitter'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XSplitter" name="XSplitter"/>'
