...
This version includes some fixes from the last stable version (2006).

This version was build from:
 * https://github.com/dnet/pyxmlsec
 * branch: master
 * version: 11725d6a415b10171f9f6767c93b1480975fa6f3
 * date: 2013-02-20
 * packager: Ernesto Revilla <ernesto.revilla@gmail.com>
...
setup(name = "pyxmlsec-next",
      version = "0.3.1",
      description = doclines[0],
      long_description = "\n" . join(doclines[2:]),
      author = "Valery Febvre and others",
      author_email = "vfebvre@easter-eggs.com",
      license = "GNU GPL",
      platforms = ["any"],
      url = "https://github.com/dnet/pyxmlsec",
