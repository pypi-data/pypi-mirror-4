...
# XXX: Need to do a trawl to see if we are depending on things that we are no
# longer using.
...
setup(
    ...
    install_requires = [
        'bzr',
        'configglue',
        'libdep-service-python>=0.0.5',
        'PIL',
        'pkgme>=0.4.1',
        'fixtures',
        'storm', # Not actually used, but libdep-service does it wrong
        ],
    entry_points = {
        'console_scripts': [
