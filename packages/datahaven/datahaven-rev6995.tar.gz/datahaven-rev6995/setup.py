...
''',
        ...
        #download_url='http://pypi.python.org/packages/source/d/datahaven/datahaven-rev6995.tar.gz',
        ...
        keywords='''backup, restore, p2p, peer-to-peer, distributed, cloud, online, storage, data, recover, python, twisted''',
        classifiers=[
