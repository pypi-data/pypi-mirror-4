...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('android_benchmark_views_app_benchmarkreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('series', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('android_benchmark_views_app', ['BenchmarkReport'])

        # Adding model 'BenchmarkRun'
        db.create_table('android_benchmark_views_app_benchmarkrun', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['android_benchmark_views_app.BenchmarkReport'])),
            ('bundle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard_app.Bundle'])),
        ))
        db.send_create_signal('android_benchmark_views_app', ['BenchmarkRun'])


    def backwards(self, orm):

        # Deleting model 'BenchmarkReport'
        db.delete_table('android_benchmark_views_app_benchmarkreport')

        # Deleting model 'BenchmarkRun'
        db.delete_table('android_benchmark_views_app_benchmarkrun')


    models = {
        'android_benchmark_views_app.benchmarkreport': {
            'Meta': {'object_name': 'BenchmarkReport'},
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'series': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16'})
        },
        'android_benchmark_views_app.benchmarkrun': {
            'Meta': {'object_name': 'BenchmarkRun'},
            'bundle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dashboard_app.Bundle']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['android_benchmark_views_app.BenchmarkReport']"})
        },
        'auth.group': {
    ...
    complete_apps = ['android_benchmark_views_app']
