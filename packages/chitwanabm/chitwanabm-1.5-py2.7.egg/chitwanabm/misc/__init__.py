...
"""
The misc folder contains code for running the chitwanabm in a lab setting where 
users lack the necessary permissions to manipulate the path and/or to install 
python packages.
"""
