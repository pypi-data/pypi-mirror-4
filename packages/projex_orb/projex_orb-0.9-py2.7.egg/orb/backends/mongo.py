    ...
    def insert( self, record, options ):
        ...
        for column in schema.columns():
            ...
            # extract the primary key information
                ...
                if ( isinstance(value.database().connection(), Mongo) ):
        ...
        if ( options.dryRun ):
            ...
            record._updateFromDatabase({'_id': str(result)})
    ...
    def update( self, record, options ):
        ...
        for colname, changevals in changes.items():
            ...
            if ( not column ):
                ...
                if ( isinstance(newValue.database().connection(), Mongo) ):
