...
__description__ = u'Python CSV to OpenERP importation library',
__license__ = u'LGPLv3+',
__version__ = u'0.7'
__all__ = ['Openerp', 'Model', 'Session', 'Field', 'show_stats', 'purge_stats']

import constants_and_vars
import lib
import tools
from tools import *
import callbacks
...
from csv2oerp import api06
from csv2oerp import api07
from csv2oerp.api07 import *
