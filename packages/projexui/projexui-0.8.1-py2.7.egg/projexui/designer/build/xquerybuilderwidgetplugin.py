...
from projexui.widgets.xquerybuilderwidget import XQueryBuilderWidget as WidgetClass

class XQueryBuilderWidgetPlugin( QPyDesignerCustomWidgetPlugin ):
    def __init__( self, parent = None ):
        super(XQueryBuilderWidgetPlugin, self).__init__( parent )
    ...
    def includeFile( self ):
        return 'projexui.widgets.xquerybuilderwidget'
    
    def domXml( self ):
        if ( hasattr( WidgetClass, '__designer_xml__' ) ):
            return WidgetClass.__designer_xml__
        
        return '<widget class="XQueryBuilderWidget" name="XQueryBuilderWidget"/>'
