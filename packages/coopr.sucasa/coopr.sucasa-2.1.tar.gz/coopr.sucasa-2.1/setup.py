...
"""
Script to generate the installer for coopr.sucasa.
"""
...
setup(name='coopr.sucasa',
      version='2.1',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.sucasa',
      license = 'BSD',
      platforms = ["any"],
      description = 'Coopr framework for integrating symbolic data into MIP solvers',
      ...
      entry_points = """
        [console_scripts]
        sucasa=coopr.sucasa.main_script:main
      """
      )
