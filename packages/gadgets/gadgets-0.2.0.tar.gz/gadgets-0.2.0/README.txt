...
Beaglebone or a Raspberry PI (gpio only, for now).  It provides an easy
way to create a system that:

* Controls devices with the Beaglebone's gpio, pwm, adc, and 1-wire interfaces
